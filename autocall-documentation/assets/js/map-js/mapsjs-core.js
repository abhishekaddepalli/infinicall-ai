(function () {
  ...
  function ha(a, b, c) {
    ...
    for (var d; a.length && (d = a.shift()); )
      !a.length && ga(b) ? (c[d] = b) : c[d] ? (c = c[d]) : (c = c[d] = {});
  }
  function ja(a) {
    a = a.split(".");
  ...
  var Ga = Array.prototype,
    ...
    Ia = Ga.forEach
      ...
      : function (a, b, c) {
          for (var d = a.length, e = ra(a) ? a.split("") : a, f = 0; f < d; f++)
  ...
  function Oa(a) {
    for (var b = Object.keys(a), c = b.length, d; c--; )
      ((d = a[b[c]]), Pa(d) && Oa(d));
    return Na(a);
  }
  function Qa(a) {
  ...
  var Sa =
    "prototype constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(
      " ",
    );
  ...
  function Ua(a, b) {
    if (!0 === (B(a, b) && a.constructor === b))
      throw new TypeError("Illegal constructor " + Va(b));
  }
  var Pa = ta;
  ...
  function Va(a, b, c, d) {
    ...
    cb(b, !0, function (b, f) {
      try {
        ...
        f = db(b, k);
        var l;
        if ((l = !(Pa(k) && k.window === k && k.self === k)))
          l = !(Pa(k) && 0 < k.nodeType && sa(k.cloneNode));
        if (l && Pa(k)) {
          if (k === a) return ((e = c + "." + f), !0);
          if (0 > d.indexOf(k) && (d.push(k), (e = Va(a, k, c + "." + f, d))))
            return !0;
        }
      } catch (m) {}
    });
  ...
  function cb(a, b, c) {
    var d, e;
    if (a) {
      for (d in a) if ((!b || gb.call(a, d)) && c(a, d, !0)) return;
      for (
        e = Sa.length;
        e-- && ((d = Sa[e]), (b && !gb.call(a, d)) || !c(a, d, !1));
      );
    }
  }
  function eb(a) {
  ...
  function jb(a, b) {
    ...
    !ib &&
      c &&
      c.warn &&
      ((d = Va(a) + " is deprecated and will be removed soon. "),
      b && (d += b),
      c.warn(d));
  }
  function C(a, b, c) {
  ...
  function Sb(a, b, c, d, e, f) {
    return tb(
      ub((a - e) * (d - f) - (b - f) * (c - e), 2) /
        (ub(c - e, 2) + ub(d - f, 2)),
    );
  }
  var Tb = { NONE: 0, Ri: 1, Li: 2, Qi: 3 };
  function Ub(a, b, c, d, e) {
    for (
      ...
      k = c[g ? g - 2 : (f + (g - 2)) % f];
      if (
        (d >= a - u && d <= a + u && h >= b - u && h <= b + u) ||
        (k >= a - u && k <= a + u && l >= b - u && l <= b + u)
      )
        n = 1;
      else if (!n && d === a)
        ((k === a && ((h < b && l > b) || (h > b && l < b))) ||
          (((m <= a && k > a) || (m >= a && k < a)) && (h >= b ? ++q : ++t)),
          (n = Rb(b, h, l, u) && Sb(a, b, d, h, k, l) <= u ? 2 : 0));
      else if (!n && Rb(a, d, k, u)) {
        if ((d < a && k > a) || (d > a && k < a))
          ((m = h + ((a - d) / (k - d)) * (l - h)), (q += m > b), (t += m < b));
        n = Rb(b, h, l, u) && Sb(a, b, d, h, k, l) <= u ? 2 : 0;
      }
      m = d;
    }
  ...
  function dc(a, b) {
    ...
    if ((e = a.S()))
      ((c = a.l(!0)) &&
        (d = a.f()) &&
        (e = e.wb(fc([a.g(0), a.g(d - 1)], !0), !0)),
        360 === e.ab() && 1 === c % 2 && (e = e.b(b, 0)));
    return e;
  }
  function gc(a, b, c, d) {
    this.lat = Wb(a, gc, 0);
  ...
  gc.prototype.distance = function (a) {
    var b, c;
    this === a || (this.lat === a.lat && this.lng === a.lng)
      ? (a = 0)
      : ((b = this.lat * Ib),
        (c = a.lat * Ib),
        (a =
          ...
          xb(
            lb(
              ...
              tb(
                ub(wb((b - c) / 2), 2) +
                  yb(b) * yb(c) * ub(wb((this.lng * Ib - a.lng * Ib) / 2), 2),
              ),
            ),
          )));
    return a;
  ...
  gc.prototype.Gf = function (a, b, c) {
    ...
    if (0 === (a + 90) % 180)
      return (
        (d =
          this.lng +
          (b / (6371000.79 * Gb * yb(this.lat * Ib))) *
            (270 === a ? -360 : 360)),
        new gc(this.lat, ((d + 540) % 360) - 180)
      );
    if ((b /= 6371000.79))
      ((a *= Ib),
        (e = this.lat * Ib),
        ...
        (g = e + b * yb(a)),
        (h = g - e),
        (d = sb(zb(g / 2 + Fb) / zb(e / 2 + Fb))),
        (d = D(h / d) ? yb(e) : h / d),
        (k = (b * wb(a)) / d),
        rb(g) > Eb && (g = 0 < g ? Db - g : -(Db + g)));
    return b
      ? new gc(
          g * Kb,
          (((f + k + Hb + (rb(e + h) > Eb ? Db : 0)) % Gb) - Db) * Kb,
        )
      : this;
  };
  ...
  function lc(a) {
    ...
    this.g =
      w.indexedDB || w.webkitIndexedDB || w.mozIndexedDB || w.msIndexedDB;
    if (!this.g)
    ...
    a.b
      ? a.a
        ...
        : a.f
          ? c && c(a.f)
          : b(a.b.result)
      : ((a.b = a.g.open(uc + a.l, 1)),
        (a.b.onupgradeneeded = a.pf),
        (d = a.b.onerror =
          function () {
            clearTimeout(a.i);
            a.f = this.error;
  ...
  function pc(a) {
    ...
    return (
      "[object Blob]" === b || "[object ArrayBuffer]" === b || ra(a) || Pa(a)
    );
  }
  function oc(a) {
    return ra(a) || ab(a);
  ...
  function wc() {
    ...
    if (!Ta(nc))
      if (
        ...
        128 <= window.location.href.length
      )
        nc = !1;
      else {
  ...
  xc.prototype.Eb = function (a, b) {
    this.pb
      ? a.call(b)
      : (this.Ta || (this.Ta = []), this.Ta.push(ga(b) ? ya(a, b) : a));
  };
  ...
  function Tc() {
    if (fa.Promise && fa.Promise.resolve) {
      ...
      Sc = function () {
        ...
        (fa.Window &&
          fa.Window.prototype &&
          fa.Window.prototype.setImmediate == fa.setImmediate)
          ? (Pc || (Pc = Qc()), Pc(a))
          : fa.setImmediate(a);
      };
  }
  ...
  function $c(a, b, c) {
    if (a.G == Yc) {
      if (a == c)
        ((b = bd), (c = new TypeError("Promise cannot resolve to itself")));
      else {
        var d;
        if (c)
          try {
  ...
  function md(a, b, c, d) {
    if (c == bd && b.b && !b.g) for (; a && a.f; a = a.b) a.f = !1;
    ...
    eg: function () {
      xd.forEach(function (a) {
        this.kc[a] = this.kc[a].filter(function (a) {
          var c, d;
          if ((c = this.ae.se(a)) !== x)
            ((d = z(this.ae.ye, this.ae, c, a)), a.then(d, d), a.Th(c));
          else return !0;
        }, this);
      }, this);
    },
  ...
  Dd.prototype.add = function (a, b, c, d, e) {
    ...
    -1 < g
      ? ((b = a[g]), c || (b.wd = !1))
      : ((b = new Bd(b, this.src, f, !!d, e)), (b.wd = c), a.push(b));
    return b;
  };
  ...
  var Gd = -1 != Jc.indexOf("Opera") || -1 != Jc.indexOf("OPR"),
    ...
    Id =
      -1 != Jc.indexOf("Gecko") &&
      !(-1 != Jc.toLowerCase().indexOf("webkit") && !Nc()) &&
      !(-1 != Jc.indexOf("Trident") || -1 != Jc.indexOf("MSIE")) &&
      !Nc(),
  ...
  var Pd = fa.document,
    ...
    Rd =
      !Pd || !Hd || (!Qd && Nc())
        ? void 0
        : Qd || ("CSS1Compat" == Pd.compatMode ? parseInt(Md, 10) : 5);
  var Td;
  (Td = !Hd) || (Td = Hd && (Nc() || 9 <= Rd));
  var Ud = Td,
    Vd = Hd && !Od("9");
  ...
  function je(a) {
    ...
    b.removeEventListener
      ? b.removeEventListener(c, d, a.ya)
      : b.detachEvent && b.detachEvent(fe(c), d);
    $d--;
    (c = de(b))
      ? (Fd(c, a), 0 == c.b && ((c.src = null), (b[Yd] = null)))
      : Cd(a);
    return !0;
  }
  function fe(a) {
  ...
  function ge(a, b) {
    ...
    if (!Ud) {
      ...
      if (!(0 > c.keyCode || void 0 != c.returnValue)) {
        ...
        for (h = 0; !d.a && h < c.length; h++)
          ((d.currentTarget = c[h]), (k = ke(c[h], f, !1, d)), (e = e && k));
      }
      return e;
    }
    return le(a, new Xd(b, this));
  }
  function de(a) {
    a = a[Yd];
  ...
  p.dispatchEvent = function (a) {
    ...
    if (b)
      for (var g = b.length - 1; !a.a && 0 <= g; g--)
        ((f = a.currentTarget = b[g]), (e = f.dc(d, !0, a) && e));
    a.a ||
      ((f = a.currentTarget = c),
      (e = f.dc(d, !0, a) && e),
      a.a || (e = f.dc(d, !1, a) && e));
    if (b)
      for (g = 0; !a.a && g < b.length; g++)
        ((f = a.currentTarget = b[g]), (e = f.dc(d, !1, a) && e));
    return e;
  };
  p.D = function () {
    I.u.D.call(this);
  ...
  I.prototype.dc = function (a, b, c) {
    ...
    if (!e || ("pointerenter" !== (f = c.type) && "pointerleave" !== f))
      ((c.eventPhase = d),
        (g = I.prototype.th.apply(this, arguments)),
        e && this.jb && null === this.jb() && delete c.eventPhase);
    return g;
  };
  function ne(a) {
    a = a || {};
  ...
  function re(a) {
    ...
    b ||
      (w.Uint8ClampedArray ||
        (w.Uint8ClampedArray = function (a) {
      ...
      "none" === a
        ? (b = new Uint8ClampedArray([0, 0, 0, 0]))
        : ((te.fillStyle = "black"),
          (te.fillStyle = a),
          qe.test(te.fillStyle)
            ? (b = new Uint8ClampedArray([c.$1, c.$2, c.$3, 255 * c.$4]))
            : (te.clearRect(0, 0, 1, 1),
              te.fillRect(0, 0, 1, 1),
              (b = te.getImageData(0, 0, 1, 1).data))),
      (se[a] = b));
    return b;
  }
  function ue(a) {
  ...
  function Fe(a, b, c) {
    ...
    if (c)
      for (a = Ee(a), c = Ee(b), d = c.length; d--; )
        c[d].getContext("2d").drawImage(a[d], 0, 0);
    return b;
  }
  function Ge(a) {
  ...
  function Ke(a, b) {
    var c = b || "",
      d;
    Je
      ? ((d = new Je()), d.append(a), (c = d.getBlob(c)))
      : (c = new Blob([a], { type: c }));
    return c;
  }
  function Le() {}
  ...
  Le.prototype.c = function (a, b) {
    b !== Me.NONE &&
      ((this.a = a),
      b & Me.SPATIAL && (this.m = a),
      b & Me.VISUAL && (this.v = a),
      b & Me.ADD && (this.l = a),
      b & Me.REMOVE && (this.o = a),
      b & Me.Z_ORDER && (this.s = a));
  };
  ...
  var Me = { NONE: 0, VISUAL: 1, SPATIAL: 2, ADD: 4, REMOVE: 8, Z_ORDER: 16 };
  Le.Flag = Me;
  function Ne(a, b, c) {
  ...
  function K(a) {
    ...
    a &&
      ...
      b in a && (this.I = +a[b] || 0),
      (b = "provider"),
      b in a && ((this.l = a[b]), this.ua(Me.ADD)),
      (b = "data"),
      b in a && this.g(a[b]));
  }
  v(K, I);
  r("H.map.Object", K);
  var Oe = new ye(),
    Pe = { ANY: 0, OVERLAY: 1, SPATIAL: 2, MARKER: 3, DOM_MARKER: 4, GROUP: 5 };
  K.Type = Pe;
  K.prototype.yb = { Hh: "visibilitychange", Ih: "zindexchange" };
  ...
  K.prototype.Ha = function (a) {
    ...
    a !== b &&
      ...
      this.dispatchEvent(new Ne(this.yb.Ih, a, b)));
    return this;
  };
  ...
  function Qe(a) {
    ...
    b ||
      ((c = (d = a.I) !== A),
      (b = a.Da) ? ((b = Qe(b).slice()), (b[0] |= c)) : (b = [c | 0]),
      b.push(d || 0, (e = a.fh) !== A ? e : a.zb),
      (a.U = b));
    return b;
  }
  ...
  function Re(a, b, c) {
    if (!c || a[0] | b[0])
      for (
        var d = a.length, e = b.length, f = lb(d, e), g, h = 1, k = 1 + c;
        h < f;
        h += k
      )
  ...
  K.prototype.F = function (a, b) {
    var c = this.l,
      ...
      e;
    if ((d = c !== a)) {
      if (b && ((c && !B(c, L)) || (a && !B(a, L))))
        throw new kc(b, "Only LocalObjectProvider allows an object transfers");
      e = this.type !== Pe.GROUP;
      c && (this.invalidate(Me.REMOVE), e && c.a(this));
      if ((this.l = a))
        (e && a.V(this), (this.Fb = x), this.invalidate(Me.ADD));
    }
    return d;
  };
  ...
  function fc(a, b) {
    ...
    var c = 1,
      ...
      f = null;
    if (0 < d)
      for (e = a[0], f = Xe(e, e, b); c < d; c++)
        ((e = a[c]), f.b(e.lat, e.lng, b, f));
    return f;
  }
  G.coverPoints = fc;
  function Ye(a, b) {
    ...
    var c = 3,
      ...
      e;
    if (0 < d)
      for (e = new G(a[0], a[1], a[0], a[1]); c < d; c += 3)
        e.b(a[c], a[c + 1], b, e);
    return e;
  }
  ...
  function Ze(a, b) {
    ...
    var c = 1,
      ...
      e;
    if (0 < d)
      for (e = new G(a[0].ka, a[0].ga, a[0].ja, a[0].ha); c < d; c++)
        e.wb(a[c], b, e);
    return e;
  }
  G.coverRects = Ze;
  ...
  $e.prototype.remove = function (a) {
    ...
    if (d && ((b = d.indexOf(a)), -1 !== b && (d.splice(b, 1), !d.length))) {
      ...
      for (
        var e = this.a;
        (d = c.a) && !(c.Y || c[0] || c[1] || c[2] || c[3]);
      )
        (c === e && (e = d), delete c.a, delete d[c.b], (c = d));
      this.a = e;
      cf(this);
    }
    (b = 0 <= b) && df(this, a, !1);
      ...
      if (((h = l.length), d > k || f < n || e > q || g < u))
        for (; h--; )
          ((k = l[h]),
            ...
            (u = k[1]),
            (y = k[2]),
            n > f || u < d || q > g || y < e || c.push(k));
      else for (; h--; ) c.push(l[h]);
    f >= m &&
      (e <= t && b[1] && gf(a, b[1], c, d, e, f, g),
      g >= t && b[3] && gf(a, b[3], c, d, e, f, g));
    d <= m &&
      (e <= t && b[0] && gf(a, b[0], c, d, e, f, g),
      g >= t && b[2] && gf(a, b[2], c, d, e, f, g));
  }
  function af(a, b, c, d, e, f) {
    a
      ? ((this.a = a),
        (this.b = b),
        b & 1 ? ((c = a[8]), (e = a[5])) : ((c = a[7]), (e = a[8])),
        b & 2 ? ((d = a[9]), (f = a[6])) : ((d = a[4]), (f = a[9])))
      : (this.b = this.a = null);
    this[7] = c;
    this[5] = e;
    this[8] = (c + e) / 2;
  ...
  jf.prototype.S = function () {
    ...
    if (!this.a) {
      ...
      if ((d = !this.f)) {
        ...
        var e;
        !(e = a.b) &&
          ((d = a.a), d.Y || d[0] || d[1] || d[2] || d[3]) &&
          ((e = [d]),
          (e = bf([e, e, e, e], [d[6], d[7], d[4], d[5]])),
          (a.b = e));
        d = a = e;
      }
  ...
  function kf(a, b, c, d, e, f) {
    f
      ? ((f = new ff(null, e, -b, c + 360, -d)),
        a.g.push(f),
        a.b && a.b.a(b, c, d, e, !0, a.b))
      : ((f = a.i),
        (f = ef(f, f.l, c, -b, e, -d, f.j)),
        a.f && a.f.a(b, c, d, e, !0, a.f));
    ++a.c;
    a.a = null;
    return f;
  }
  jf.prototype.remove = function (a) {
    ...
    else if (((a = (b = this.g).indexOf(a)), (c = 0 <= a)))
      (b.splice(a, 1), (this.b = null));
  ...
  function lf(a, b, c, d, e) {
    ...
    var f = a.length,
      ...
      l;
    if (f)
      for (k = c + 360, l = e + 360; f--; )
        ((g = a[f]),
          mf(g, b, c, d, e) ? h.push(g) : mf(g, b, k, d, l) && h.push(g));
    return h;
  }
  ...
  function of(a, b) {
    ...
    b.g()
      ? ((h = c.bb(-180, f, e, g)),
        nf(h, c.bb(d, f, 180, g)),
        nf(h, lf(a, f, e, g, d + 360)))
      : ((h = c.bb(d, f, e, g)), nf(h, lf(a, f, d, g, e)));
    return h;
  }
  function F(a, b) {
  ...
  F.prototype.i = function (a, b, c) {
    ...
    d = c
      ? this.na.splice.apply(this.na, [a, b].concat(c))
      : this.na.splice(a, b);
  ...
  function pf(a, b, c) {
    for (var d = a.length, e = !(d % 3), f; e && d; )
      e = !(
        D((a[--d] = Yb((f = a[d]) === A ? 0 : f))) ||
        D((a[--d] = Xb(a[d]))) ||
        D((a[--d] = Wb(a[d])))
      );
  ...
  F.prototype.pa = function (a) {
    var b = this === a,
      ...
      d;
    if (!b && (b = B(a, F)))
      for (c = this.na, a = a.na, b = (d = c.length) === a.length; b && d--; )
        b = c[d] == a[d];
    return b;
  };
  ...
  function xf(a) {
    ...
    if (!b)
      for (
        b = a.m = new jf(), c = 0, a = a.na, d = a.length, e = 0;
        e < d;
        e += 3
      ) {
        f = a[e];
  ...
  var Df = Na({}),
    Cf = [
      ...
      function (a) {
        return "butt" === (a = La(a)) || "square" === a || "round" === a
          ? a
          : Df;
      },
      function (a) {
  ...
  Gf.prototype.O = function (a) {
    var b = this.style,
      c = !0;
    a
      ? (this.style = B(a, zf) ? a : new zf(a))
      : this.style
        ? delete this.style
        : (c = !1);
    c &&
      (this.dispatchEvent(new Ne("stylechange", this.style, b)),
      this.invalidate(Me.VISUAL));
    return this;
  };
  ...
  Gf.prototype.Vb = function (a) {
    ...
    !a && b
      ? (delete this.s, (c = !0))
      : !a || (b && b.pa(a)) || ((this.s = new Ff(a)), (c = !0));
  ...
  Pf.prototype.pa = function (a) {
    ...
    if (!b && (b = B(a, this.constructor)))
      for (c = this.ma, a = a.ma, b = (d = c.length) === a.length; b && d--; )
        b = c[d].pa(a[d]);
    return b;
  };
  ...
  Pf.prototype.Lb = function (a) {
    ...
    if (c) {
      ...
      for (d = 0; d < c; d++)
        ((e = 0 < d && f) && a.push(","),
          b[d].Lb(a),
          "EMPTY" === a[a.length - 1] ? a.splice(-1 - e, 1 + e) : (f = !0));
  ...
  function Xf(a, b, c, d, e) {
    ...
    if (360 === e.ab() && 1 === b.l(!0) % 2) {
      ...
      for (h = 0; h < k; h++)
        ((m = b[0][h]),
          (l[h] = new M(m.x - 2 * g.w, m.y)),
          (l[h + k] = new M(m.x - g.w, m.y)),
          (l[h + 2 * k] = new M(m.x, m.y)),
          (l[h + 3 * k] = new M(m.x + g.w, m.y)),
          (l[h + 4 * k] = new M(m.x + 2 * g.w, m.y)));
      b[0] = l;
      g = g.f(d, 0);
    ...
    if (Zf(b, d, g, a, f, !0).length) {
      if (!c.s().j(e)) {
        ...
        for (d = c.length; d--; ) {
              ...
              if (!m.bb)
                for (n = g; n.next; n = n.next)
                  !n.bb &&
                    ...
                    (u = a.Hi),
                    (y = a.Ii),
                    (q = ag(u, y, null, null, null, null, 1, 0, 0, q)),
                    eg(q, m, t),
                    (t = ag(u, y, null, null, null, null, 1, 0, 0, J)),
                    eg(t, n, T),
                    (q.df = t),
                    (t.df = q));
            a = fg(b, g);
          ...
          if (g)
            for (b = ig(g), f.push(b); g.ef; )
              ((g = g.ef), (b = ig(g)), f.push(b));
        }
        b = f;
      }
    } else
      ((c = jg(d, g, b[0])), b[1] && (c ^= jg(d, g, b[1])), (b = c ? [Tf] : A));
    return b;
  }
  function jg(a, b, c) {
    var d, e, f, g, h, k, l, m;
    ...
    for (m = c.length; d < m; d++)
      ((k = c[d].x),
        ...
        k > g ? (g = k) : k < e && (e = k),
        l > h ? (h = l) : l < f && (f = l));
    return e <= a && a <= g && f <= b && b <= h
      ? 1 === fg({ x: a, y: b }, c.concat(c[0]))
      : !1;
  }
  function ig(a) {
    var b = [],
    ...
    do {
      ...
      if (!c || 0.01 < tb(ub(c.x - e, 2) + ub(c.y - f, 2)))
        ((c = new M(e, f)), b.push(c));
      d = d.next;
    } while (d && d !== a);
    return b;
  }
  ...
  function Yf(a, b) {
    ...
    for (h = 0; h < g; h += 3)
      ((k = d[h]),
        ...
        m ||
          180 != rb(l) ||
          (f.push(k), f.push(l), f.push(k), f.push(-l), (m = !0)),
        f.push(k),
        f.push(l));
    d = f;
      ...
      -1 !== d &&
        ...
        180 !== rb(g) &&
          ...
          k &&
            ...
            (g = h + (h > g ? -l : l)),
            (f = 0 < f ? 180 : -180),
            e.splice(d, 0, g, f, g, -f))));
      d = e;
    }
    c[0] = kg([].concat(d), b.ga);
    360 > b.ab() &&
      b.Vc(new gc(b.ka, 180)) &&
      ((d = kg([].concat(d), b.ha)), c.push(d));
    return c;
  }
  Uf.prototype.Tb = function () {
    ...
    jb(Uf.prototype.Tb);
    if (this.m)
      for (b = a.ma, d = b.length, a = [], c = 0; c < d; c++)
        a = a.concat(Yf(b[c].$a, b[c].S()));
    else a = Yf(a.$a, a.S());
    return a;
  };
  ...
  function kg(a, b) {
    for (
      var c = [], d = Number.POSITIVE_INFINITY, e = -1, f, g = a.length, c = 0;
      c < g;
      c += 2
    )
      ((f = rb(a[c + 1] - b)),
  ...
  function ng(a) {
    ...
    else for (a = a.a, a = 360 / a; 360 > e; e += a) f.c(b.Gf(e, d, !0));
    b = new E(f);
    0 > c && b.i(cc.SOUTH);
    return b;
  }
  ...
  pg.prototype.c = function (a) {
    var b = this.c,
      ...
      e;
    if (B(a, og))
      if (((c = a.ma), (d = c.length))) for (e = 0; e < d; e++) qg(c[e], b);
  ...
  pg.prototype.ec = function (a) {
    ...
    var c,
      d = [];
    if (this.m) for (b = b.ma, c = b.length; c--; ) rg(this, b[c], a, d);
    else rg(this, b, a, d);
    return d.length ? d : A;
  };
  ...
  function rg(a, b, c, d) {
    var e = yf(b, c.s()),
      f;
    e.length &&
      ((b = c.B()), (a = Kf(a, e, !1, b)), (e = a.length)) &&
      ((f = c.j()),
      (b = b.w),
      c.x || Nf(a, e, -b),
      c.x === (1 << c.z) - 1 && Nf(a, e, b),
      (c = Zf(a, f.left, f.top, f.right, f.bottom, !1)),
      c.length && d.push(new Sf(c)));
  }
  function sg(a) {
  ...
  function tg(a, b, c) {
    var d,
      e = 6;
    if (b) {
      for (d = ' expected close to: "' + b; e--; )
        ((b = a.a.next()), -1 !== b && (d += String.fromCharCode(b)));
      d += '"';
    }
    throw new C(
      ug,
      0,
      "- Malformed WKT: " + (d ? c + d : "unexpected end of stream"),
    );
  }
  var vg = { Eh: " ", Ch: "(", Dh: ")", sh: ",", wh: "" };
  ...
  function yg(a) {
    ...
    if (b === A) {
      ...
      if (Lg[b.a()])
        ((b = b.next()), (b = b === Mg ? "" : String.fromCharCode(b)));
      else {
        b.m();
        do b.next();
        while (!Lg[b.a()]);
  ...
  var Kg = 32,
    Mg = -1,
    Ng = { Eh: Kg, Ch: 40, Dh: 41, sh: 44, wh: Mg },
  ...
  function Qg(a) {
    ...
    this.uid = b;
    a.getCopyrights &&
      Xa(a.getCopyrights, "Function", Qg) &&
      (this.getCopyrights = a.getCopyrights);
    Qg.u.constructor.call(this);
  }
  v(Qg, I);
  r("H.map.provider.Provider", Qg);
  Qg.prototype.F = { la: "update" };
  function Rg(a, b) {
  ...
  function Sg(a) {
    ...
    if (a && "tileSize" in a) {
      b = sb(+a.tileSize) / Cb;
      if (isNaN(b) || b % 1 || 0 > b || 30 < b)
        throw new C(Sg, 0, "tileSize: " + a.tileSize);
  ...
  Vg.prototype.add = function (a, b, c) {
    ...
    d
      ? e
        ? ((this.a += c - d.size), (d.size = c), (d.data = b), Wg(this, d))
        : Xg(this, d, !0)
      : e &&
        (this.Y[a] = Yg(
          this,
          { id: a, data: b, size: c, xb: null, Xb: null },
          this.b,
        ));
    Zg(this);
    return e;
  ...
  Vg.prototype.forEach = function (a, b, c) {
    ...
    for (e in this.Y)
      ((d = this.Y[e]),
        (c ? c(e, d.data, d.size) : 1) && a.call(b, e, d.data, d.size));
  };
  ...
  Vg.prototype.Ea = function (a) {
    ...
    for (c in this.Y)
      ((b = this.Y[c]),
        (a ? a(c, b.data, b.size) : 1) && Xg(this, this.Y[c], !0));
  };
  ...
  function Xg(a, b, c) {
    ...
    if (d || e || (b == a.b && b == a.f))
      (d ? (d.xb = e) : (a.b = e),
        e ? (e.Xb = d) : (a.f = d),
        (a.a -= b.size),
        c && (a.j && a.j(b.id, b.data, b.size), delete a.Y[b.id]));
    b.xb = b.Xb = null;
  }
  function $g(a, b, c, d) {
    this.key = "";
  ...
  function ch(a, b, c, d, e, f) {
    var g = a.B();
    d = ~~d;
    return a.requestInternal(
      b,
      c,
      d,
      function (h, k) {
        g.gd(a.A(b, c, d), k && { raw: k.zi, timestamp: w.Date.now() }, e, f);
      },
      f,
      0,
    );
  ...
  N.prototype.o = function (a, b, c, d) {
    ...
    (g && g.valid) ||
      ...
      (h = function (d) {
        ...
        d && h < e.MAX_STORE_TIME
          ? e.Ga(d.raw, function (h) {
              delete e.a[f];
  ...
  eh.prototype.c = function (a, b, c, d, e) {
    ...
    return this.ea(
      ...
      c,
      function (e) {
        for (var h = [], k, l, m = e.length; m--; )
          ((l = e[m]),
            (l.Di = f.getTileKey(a, b, c)),
            l.ia(f),
            (k = l.sb()),
            (B(l, fh) || k.getState() === k.Pc.READY) && h.push(e[m]));
        d(h);
      },
      e,
    );
  ...
  M.prototype.a = function (a, b) {
    var c = b.x - a.x,
      ...
      f = a;
    if (c || d)
      ((e = ((this.x - a.x) * c + (this.y - a.y) * d) / (c * c + d * d)),
        0 >= e
          ? (f = a)
          : 1 <= e
            ? (f = b)
            : (f = new M(a.x + e * c, a.y + e * d)));
    return f;
  };
  ...
  r("H.geo.mercator", ih);
  ih.a = function (a) {
    return lb(1, mb(0, 0.5 - sb(zb(Fb + (Eb * a) / 180)) / Db / 2));
  };
  ih.b = function (a) {
    return a / 360 + 0.5;
  };
    ...
    return b
      ? 0 >= a
        ...
        : 1 <= a
          ? 180
          : 360 * Ob(a, 1) - 180
      : 360 * (1 === a ? 1 : Ob(a, 1)) - 180;
  };
  ih.Aa = function (a, b, c, d) {
    c
      ? ((c.lat = ih.f(b)), (c.lng = ih.c(a, d)))
      : (c = new gc(ih.f(b), ih.c(a, d)));
    return c;
  };
  ih.xyToGeo = ih.Aa;
  ...
  mh.prototype.a = { la: "update", Uf: "minchange", Tf: "maxchange" };
  ...
  mh.prototype.B = function (a) {
    ...
    if (a !== b) {
      ...
      if (a <= this.max)
        ((this.min = a), this.dispatchEvent(new Ne(this.a.Uf, a, b)), this.l());
  ...
  mh.prototype.s = function (a) {
    ...
    if (a !== b) {
      ...
      if (a >= this.min)
        ((this.max = a), this.dispatchEvent(new Ne(this.a.Tf, a, b)), this.l());
  ...
  function rh(a, b, c, d, e) {
    ...
    var l = b.bottom,
      ...
      q;
    e &&
      ((n = g + (1 + k - g) / 2 + e.x / a.tileSize - 0.5),
      (q = h + (1 + l - h) / 2 + e.y / a.tileSize - 0.5));
    for (; g < c; ) {
      for (h = b.top; h <= l; )
        ((a = g % f), m.push([a, h, d, e ? rb(n - g) + rb(q - h) : 0]), h++);
      g++;
    }
    return m;
  }
  ...
  nh.prototype.o = function (a, b, c, d, e, f) {
    ...
    b = rh(this, a, b, c, e);
    if ((a = b.length))
      for (d || b.sort(th), c = a; c--; )
        ((e = b[c]),
          d || (g[l.A.apply(l, e)] = !0),
          (e[3] = +d),
          (k = m.apply(l, e)) && h.push(k));
    if (!d) {
      d = g;
      var n;
      g = this.N[f] || {};
      for (n in g)
        g.hasOwnProperty(n) && g[n] && !d[n] && this.f.cancelTileByKey(n);
      this.N[f] = d;
    }
    return { total: a, tiles: h };
  };
  ...
  var vh = { markers: [], total: 0, requested: 0 };
  function wh(a, b, c, d, e) {
    ...
    return { markers: e, total: a.length, requested: c };
  }
  ...
  xh.prototype.o = function (a) {
    ...
    a.pa(this.kb) ||
      ((this.kb = this.a = a), this.i !== x && xh.u.c.call(this, yh(this)));
  };
  ...
  function yh(a) {
    ...
    180 <= b.ab() &&
      (a.splice(9, 0, e, (d = b.Oa().lng), A), a.splice(3, 0, c, d, A));
  ...
  Ch.prototype.i = function (a) {
    var b = a.type,
      ...
      g = !0;
    c
      ? ((this.b[e] = a), Fh(this, b, e, d && d.message, f))
      : (a.reject(new C(this.i, 0, "processor_not_found")), (g = !1));
    return g;
  };
  ...
  Ch.prototype.g = { IDLE: "idle", ERROR: "error" };
  ...
  function Dh(a) {
    ...
    if (w.Worker && w.URL)
      try {
        c = new w.Worker(
          w.URL.createObjectURL(Ke(b, "application/javascript")),
        );
      } catch (d) {}
    c ||
      ((a = new Jh(a)),
  ...
  Ca(Lh.prototype, {
      ...
      if ((d = this.Zg[a]))
        ((b = this.Hf),
          ...
          c ||
            ((c = b[0] = new Ch()),
            this.Eb(za(Ac, c)),
            Wa(this.Ed) || c.importScripts(w.Object.keys(this.Ed))),
          (b = c),
          b.f[a] ||
            ((b.f[a] = d),
            Ih(b, "1", [a, sa(d) ? d + "" : d]).then(sc, z(b.l, b, a))));
    ...
    md: function (a, b) {
      ...
      if (d) {
        if (b !== d)
          throw new kc(this.md, 'Type "' + a + '" is already registered');
      } else c[a] = b;
    },
  ...
  function Rh(a, b) {
    ...
    b &&
      ((c = "onAttach"),
      c in b && Xa((d = b[c]), "Function", Rh, 1, c) && (this.ff = d),
      (c = "onDetach"),
      c in b && Xa((d = b[c]), "Function", Rh, 1, c) && (this.f = d));
  }
  r("H.map.DomIcon", Rh);
  ...
  function Uh(a, b) {
    ...
    if (a !== Vh.NONE) {
      ...
      for (; d--; ) if (D(l[d])) throw new C(Uh, 1, l);
      f === Vh.RECT &&
        3 < c &&
        ((l = [l[0], l[1], l[2], l[1], l[2], l[3], l[0], l[3]]),
        (f = Vh.POLYGON));
      if (f === Vh.CIRCLE && 2 < c && ((e = l[2]), 0 < e)) {
        ...
        h = 360 / d;
        for (l = []; d--; )
          ((k = h * d * Ib), l.push(f + wb(k) * e, g + yb(k) * e));
        f = Vh.POLYGON;
      }
  ...
  r("H.map.HitArea", Uh);
  var Vh = { NONE: 0, RECT: 1, CIRCLE: 2, POLYGON: 3 };
  Uh.ShapeType = Vh;
    ...
    if (b !== a) {
      if (!B(a, this.pg))
        throw (
          C.apply(
            (b = new C()),
            c ? [this.constructor, 1, "icon"] : [this.a, 0, a],
          ),
          b
        );
      this.icon = a;
  ...
  Zh.error = function () {
    Zh.a ||
      ((Zh.a = new Zh(null, { status: 0, statusText: "" })),
      (Zh.a.type = "error"));
    return Zh.a;
  };
  Zh.error = Zh.error;
  ...
  function $h(a, b, c) {
    ...
    try {
      e.open(b, a, !0);
      for (f in h)
        h.hasOwnProperty(f) && (g = h[f]) && e.setRequestHeader(f, g);
      e.withCredentials = !!k.withCredentials;
      d();
    } catch (m) {
      if (di) this.b({ type: "cors" });
      else {
  ...
  r("H.net.Xhr", $h);
  var ci = { method: "GET", headers: {}, data: null },
  ...
  $h.prototype.b = function (a) {
    ...
    "load" === b
      ? a instanceof XMLHttpRequest && 200 !== a.status && (c = "network")
      : (c =
          4 === a.readyState && 0 === a.status && "error" == b
            ? "cors"
            : "error" != b
              ? b
              : "network");
    ...
    ei(this, "error", b);
    ei(this, "load", b);
    0 === a.status || (c && "network" !== c)
      ? (d = Zh.error())
      : (d = new Zh(a.responseText, a));
    c = this.c;
    delete this.b;
    delete this.c;
    delete this.a;
  ...
  Ca(fi.prototype, {
    ...
    se: function (a) {
      ...
      var b = this.Jc[a] || 0,
        c;
      return this.xf < this.oi && b < this.pi
        ? ((c = this.Fi()),
          this.xf++,
          (this.Jc[a] = b + 1),
          (this.uf[c] = a),
  ...
  (function () {
    ...
    "response" in a &&
      (Gh.prototype.b.arraybuffer = function () {
    ...
    if (!b)
      if (a in ji) b = ii[a] = a;
        ...
        if ((b = f ? e : null)) ii[a] = b;
          ...
          throw Error("Could not find any variant of CSS property [" + a + "]");
      }
    return b;
  }
  ...
  function mi(a, b, c, d, e) {
    ...
    e && (this.f = { crossOrigin: "anonymous" });
    switch (ni[Ya(a)]) {
      case 2:
        this.ic = a;
        oi(this, 1);
  ...
  var ni = { String: 0, HTMLImageElement: 1, HTMLCanvasElement: 2 };
  mi.prototype.b = x;
  function qi(a) {
    var b = a.b,
      c,
  ...
  r("H.map.Icon", ri);
  var si = new ye();
  ri.prototype.Pc = { ERROR: -1, LOADING: 0, READY: 1 };
  ...
  ri.prototype.D = function () {
    ri.u.D.call(this);
    this.c
      ? (this.c.removeAttribute("src"), delete this.c)
      : (this.f.cancel(), delete this.f);
  };
  var ti = he;
  ...
  var wi = le,
    le = function (a, b) {
      ...
      if (!d || ("pointerenter" !== (e = b.type) && "pointerleave" !== e))
        ((b.eventPhase = c),
          (f = wi(a, b)),
          d && a.src && a.src.jb && null === a.src.jb() && delete b.eventPhase);
      return f;
    };
  function xi(a, b) {
  ...
  p.ua = function (a) {
    var b;
    if (a !== Me.VISUAL || 1 === this.Yg || 1 === this.icon.getState())
      b = xi.u.ua.call(this, a);
    return b || !1;
  };
  p.Yg = 0;
  p.pg = ri;
  ...
  p.$b = function (a) {
    var b = this.icon;
    this.Le &&
      (b.removeEventListener("statechange", this.Hg, !1, this), delete this.Le);
    b && (this.Yg = b.getState());
    xi.u.$b.call(this, a);
    0 === a.getState() &&
      ((this.Le = !0), ti(a, "statechange", this.Hg, !1, this));
    return this;
  };
  ...
  function Ai(a, b, c) {
    ...
    var d;
    if (c) d = a;
    else if (D((d = 0 > (d = +b) ? mb(0, a + d) : lb(a, d))))
      throw new ec(zi, b, [0, a - 1]);
    return d;
  }
  ...
  zi.prototype.a = { Lc: "add", Nc: "remove", td: "set", Pi: "move" };
  ...
  function Di(a) {
    ...
    if (a) for (var b = 0, c = a.length; b < c; b++) this.add(a[b]);
  }
  v(Di, zi);
  ...
  Di.prototype.b = function (a) {
    var b;
    (b = Di.u.b.call(this, a)) &&
      b.removeEventListener(b.a.la, this.dispatchEvent, !1);
    return b;
  };
  Di.prototype.removeAt = Di.prototype.b;
  Di.prototype.remove = function (a) {
    var b;
    (b = Di.u.remove.call(this, a)) &&
      a.removeEventListener(a.a.la, this.dispatchEvent, !1);
    return b;
  };
  ...
  r("H.util.Request", Ei);
  Ei.State = { PENDING: 0, PROCESSING: 1, COMPLETE: 2, CANCELLED: 3, ERROR: 4 };
  var Fi = { Vf: 0, ne: 1, le: 2, Ji: 3, ERROR: 4 },
    Gi = [0, 1, 2, 3, 4];
  Ei.prototype.G = 0;
  ...
  function Hi(a, b) {
    a.b < a.a &&
      ...
      b === Fi.Vf ||
        b === Fi.ne ||
        (a.G !== Fi.Vf && a.G !== Fi.ne) ||
        (a.b++, b !== Fi.le && a.g++, a.L(a.b < a.a ? Fi.ne : Fi.le)));
  }
  ...
  function Ji(a, b) {
    ...
    this.a = a;
    this.b = c = c.appendChild(
      Ki(
        d,
        "DIV",
        "position:absolute;bottom:4.55em;left:0.5em;z-index:1;height:0px;direction:ltr",
      ),
    );
    this.ve = Ki(
      d,
      "DIV",
      "position:absolute;top:0px;pointer-events:none;",
      Li,
    );
    ...
    c = c.appendChild(
      Ki(
        d,
        "DIV",
        "-webkit-touch-callout: none;-webkit-user-select:none;-khtml-user-select: none;-moz-user-select: none;-ms-user-select: none;user-select:none;whiteSpace:nowrap;position:relative;top:2.73em;padding-left:1px",
      ),
    );
  ...
  Ji.prototype.f = function () {
    ...
    b.g().type !== Pi
      ...
      : ((b = b.c.Ab()),
        ...
        (c.href =
          a +
          [e.lat, e.lng, 22, b.yaw, 90 + b.pitch].join() +
          ",panorama.day,report"));
  ...
  Ji.prototype.ya = function (a, b, c, d) {
    ...
    e.font = g * b + "px " + f.getPropertyValue("font-family");
    ...
    Si(
      z(function (a) {
        a
          ...
          : ((a = this.ve.cloneNode(!0)),
            a.firstChild.setAttribute("style", "font:" + b),
            c(xe(a.innerHTML)));
      }, a),
      d,
    );
  ...
  function Si(a, b) {
    ...
    Ta(d)
      ? a(d)
      : new Gh("image", c).then(function (b) {
          te.drawImage(b, 0, 0);
          try {
  ...
  p.hg = function (a) {
    ...
    b &&
      this.c &&
      ((b = Zi(this.c)),
      0 !== b && ((c = Zi(this.a)), (a = sb(ub(2, a) * (c / b)) / Cb)));
    return a;
  };
  function bj(a, b, c, d) {
  ...
  p.setVisibility = function (a) {
    a !== this.tg &&
      ((this.a.style.display = a ? "block" : "none"), (this.tg = a));
  };
  p.Se = 1;
  function dj(a, b) {
  ...
  fj.prototype.ca = function (a, b, c, d, e, f) {
    ...
    if (
      d >= k.min &&
      d <= k.max &&
      ((l = this.fg(a, d, e, f)), (m = l.markers), (a = m.length))
    ) {
      d = [];
      e = this.b;
      dj(e, k.opacity);
      for (k = 0; k < a; k++)
        for (f = m[k], n = gj(f), q = n.length; q--; )
          if ((t = c.geoToPixel(n[q])))
            (this.l || ((u = c.w), (t.x -= nb(t.x / u) * u)),
              t.add(b),
              (u = g[(y = f.ta() + "_" + q)])
                ? delete g[y]
                : (u = { marker: f }),
              (h[y] = u),
              d.push([u, f, f.sb(), e, t.x, t.y]));
      d.sort(hj);
      a = d.length;
      for (k = 0; k < a; k++) this.wg.apply(this, d[k]);
    }
    return !l ||
      (l.requested && l.requested === l.total) ||
      (!l.requested && m.length === l.total)
      ? ij.DONE
      : ij.PENDING;
  };
  function hj(a, b) {
    return (
      Re(Qe(a[1]), Qe(b[1]), !0) || a[5] - b[5] || Re(Qe(a[1]), Qe(b[1]), !1)
    );
  }
  function jj(a, b) {
  ...
  p.Ee = function () {
    for (var a = this.c.length, b, c, d; a--; )
      ((d = this.c[a]), (b = d.sd), (c = d.sd.sb()), c.ff(d, c, b));
    this.c.length = 0;
  };
  p.wg = function (a, b, c, d, e, f) {
    ...
    h ||
      ((a.detail = h = Fe(c.i, this.i, c.c)),
      this.f++,
      sa(c.ff) && this.c.push(h));
    a.bi = g.a;
  ...
  if (ve) {
    ...
    ve &&
      jc !== x &&
      (jc = (oj = /(MSIE\s+|rv\:)([^\);]+)(\)|;)/.exec(navigator.userAgent))
        ? +oj[2]
        : x);
    nj = jc;
  ...
  jj.prototype.Ma = function (a, b, c) {
    ...
    if (this.f) {
      ...
      for (
        ...
        for (; (q = l.parentNode) && (!sa(q.contains) || !q.contains(f)); )
          l = q;
        if (
          q === f &&
          (l !== m || "svg" !== l.nodeName) &&
        ...
        n.setProperty(lj, "visibility" === lj ? "hidden" : "none", "important");
        n = m;
      }
      if (k)
        for (b = k.length; b--; )
          ((a = k[b]),
            a.style.removeProperty(lj),
            ra(a.bg) && a.style.setProperty(lj, a.bg, a.$h));
    }
    return h;
  };
    ...
    for (h = 0; h < f; h++) {
      ...
      if ((l = n.data))
        if (
          ...
          for (t = c; (t -= u) > k; ) q.bc(l, t, m, d, d);
          for (t = c; (t += u) < g; ) q.bc(l, t, m, d, d);
        }
  ...
  pj.prototype.Ma = function (a, b, c) {
    if (Ta(this.c)) {
      ...
      rb(l) >= h && (l %= h);
      0 > l && (l = h + l);
      (h = this.f[this.c + "_" + l + "_" + g]) &&
        h.Ma &&
        (k = h.Ma((a - d * f) / e, (b - d * g) / e, c));
    }
    return k || De;
  };
  ...
  var rj,
    sj = (function () {
      function a() {}
      for (var b, c, d, e = Ra("o ms moz webkit "), f = 5; f-- && !b; )
        ((b = e[f]),
          (b =
            (c = w[b + (b ? "R" : "r") + "equestAnimationFrame"]) &&
            !D(c.call(window, a)) &&
            (d = w[b + (b ? "C" : "c") + "ancelAnimationFrame"])));
      rj = b
        ? function (a) {
            return c.call(w, a);
          }
  ...
  var ij = { PENDING: 0, ACTIVE: 1, DONE: 2 };
  ...
  function uj(a, b) {
    ...
    d.style.position =
      "relative" === a.style.position ? "absolute" : "relative";
    this.resize();
    a.appendChild(d);
  ...
  v(uj, I);
  r("H.map.ViewPort", uj);
  uj.prototype.a = { la: "update", Oc: "sync" };
  uj.prototype.g = !0;
  ...
  function vj(a) {
    var b = a.padding;
    a.center.set(
      ((a.width + b.left - b.right) / 2) << 0,
      ((a.height + b.top - b.bottom) / 2) << 0,
    );
  }
  uj.prototype.resize = function () {
    ...
    if (this.width !== a || this.height !== b)
      ((this.m = new Th(this.width, this.height)),
        (this.width = a),
        (this.height = b),
        vj(this),
        this.dispatchEvent(this.a.la));
  ...
  var Aj = { ZOOM: 1, HEADING: 2, TILT: 4, INCLINE: 8, COORD: 16 };
  wj.InteractionModifiers = Aj;
  wj.prototype.ee = { Xf: "render" };
  var Bj = { P2D: 0, PANORAMA: 1 };
  wj.EngineType = Bj;
  ...
  p.clear = function (a) {
    ...
    this.c &&
      (a
        ? this.b.clearRect((b = a.left), (c = a.top), a.right - b, a.bottom - c)
        : (this.a.width = this.size.w));
  };
  p.D = function () {
  ...
  Dj.prototype.g = { Mf: "animationupdate" };
  function Ej(a) {
  ...
  function Fj(a) {
    return { x: 91.401472 * a.b, y: 91.401472 * a.c, z: a.f };
  }
  ...
  Ij.prototype.ca = function (a, b, c, d, e) {
    ...
    if (
      d >= h.min &&
      d <= h.max &&
      ((k = h.C(a, d, e)), (l = k.overlays), (a = l.length))
    )
      for (
        l.sort(Se), d = this.b, e = this.Nb, ob = h.opacity, h = 0;
        h < a;
        h++
      )
        ((m = l[h]),
          ...
          (n = c.w),
          q.x >= t.x && (q.x -= n),
          this.g || (u = -(((q.x + t.x) / n) >> 1) * n),
          (q.x += u),
          q.add(b),
          (t.x += u),
          t.add(b),
          e || (q.round(), t.round()),
          (n = f[(y = m.ta())]) ? delete f[y] : (n = { vi: m }),
          (g[y] = n),
          (J = q.x),
          (q = q.y),
          (T = t.x),
          ...
          dj(d, m.Bd() * ob),
          d.bc(m.Pb(), J, q, ea, la),
          n.Ae ? n.Ae.set(J, q, T, t) : (n.Ae = new qh(J, q, T, t)),
          this.c.push(n));
    return !k ||
      (k.requested && k.requested === k.total) ||
      (!k.requested && l.length === k.total)
      ? ij.DONE
      : ij.PENDING;
  };
  ...
  p.wg = function (a, b, c, d, e, f) {
    ...
    d.bc(c.Pb(), e, f, b, g);
    a.detail
      ? a.detail.set(e, f, e + b, f + g)
      : (a.detail = new qh(e, f, e + b, f + g));
    this.c.push(a);
  };
  p.Ma = function (a, b, c) {
    for (
      var d = this.c, e = d.length, f, g, h, k = De;
      e-- &&
      !((f = d[e]),
      (g = f.detail),
      g.a(a, b) &&
        ((f = f.marker),
        (!(h = f.sb().g) || h.a(a - g.left, b - g.top, 0)) &&
          0 > k.indexOf(f) &&
          (k === De && (k = []), k.push(f), c)));
    );
    return k;
  ...
  p.bc = function (a, b, c) {
    ...
    a.parentNode !== this.a &&
      ((e.position = "absolute"), this.a.appendChild(a));
  };
  p.clear = function (a) {
  ...
  function Tj(a, b, c) {
    var d,
      ...
      h,
      k = [],
      l = { ac: a.a, width: b.w, height: b.h, za: a.b };
          ...
          if ((d = f && "2d" === f.f)) {
            ...
            d =
              m === d
                ? !0
                : m && !d
                  ? !m.alpha && !m.willReadFrequently
                  : d && !m
                    ? !d.alpha && !d.willReadFrequently
                    : !d.alpha === !d.alpha &&
                      !m.willReadFrequently === !d.willReadFrequently;
          }
          d
            ? (h = !1)
            : e && !h
              ? ((f = e), (h = !1))
              : ((f = new Cj(g.ac, g.width, g.height, g.za, "2d", g.xe)),
                (h = !0));
          break;
        case 2:
          ...
          break;
        default:
          ((f = e || new Cj(g.ac, g.width, g.height, g.za, b.a.v, g.xe)),
            (h = !e));
      }
  ...
  function yj() {
    ...
    this.a = {};
    this.g = { position: new gc(0, 0), pitch: 0, yaw: 0, roll: 0, fov: 70 };
    this.b = 0;
  }
  v(yj, I);
  r("H.map.ViewModel", yj);
  yj.prototype.c = { la: "update", Oc: "sync" };
    ...
    for (a.j = {}; e--; )
      if (((f = d[e]), (h = c[f]), (g = b[f]), null != h)) {
        if (
          ...
          (a.j[f] = h),
          (b[f] = h),
          ($b(h) && $b(g) && (h.lat !== g.lat || h.lng !== g.lng)) ||
            (!$b(h) && h !== g))
        )
          a.f |= Uj[f];
      } else delete b[f];
  ...
  yj.prototype.Jb = function (a) {
    ...
    b = this.a.zoom;
    a = Vj(this, {}, a, this.i);
    this.a = { animate: c, zoom: b, camera: a };
  ...
  yj.prototype.l = function (a, b) {
    ...
    this.a = { animate: b, zoom: a, camera: this.a.camera || this.g };
    this.dispatchEvent(new Wj(this.a));
  };
  ...
  function O(a, b, c, d) {
    ...
    this.K = new M(0, 0);
    if ((e = d.renderBaseBackground))
      ((this.Bh = e.lower), (this.Ah = e.higher));
    this.zh = !!d.enableSubpixelRendering;
    this.yb = !!d.noWrap;
    this.Vb = Yj;
    this.he = this.b = 0;
    this.jc = this.Yd = !1;
    this.l = new M(0.5, 0.5);
  ...
  O.prototype.zb = function (a) {
    ...
    if (f) {
      if (
        ...
        (q = { x: m.x, y: m.y }),
        (f = this.a.b(q).x),
        (t = this.a.projection.qb(e)),
        t.x !== this.l.x || t.y !== this.l.y || c !== this.b)
      )
        ((h = fk(this, f, h)),
          ik(
            this,
  ...
  function qk(a, b, c, d) {
    var e, f, g, h, k;
    c &&
      ((k = { Nb: a.zh, yi: a.i, noWrap: a.yb }),
      c.ca
        ? B(c, Oh)
          ? (f = new Mj(c))
          : B(c, Qh) && (h = new Mj(c))
        : (c.requestOverlays && (e = new Ij(c, k)),
          c.requestTiles && (f = new pj(c, k)),
          c.requestMarkers && (g = new Lj(c, k)),
          c.requestDomMarkers && (h = new jj(c, k))));
    d = d || 0;
    a.U.Fa.splice(b, d, e);
    a.F.Fa.splice(b, d, f);
  ...
  function hk(a, b) {
    ...
    e = wk({ position: new gc(e.lat, e.lng) });
    a.b = c.animate ? a.b : d;
    e.zoom = d;
    return e;
  }
  ...
  O.prototype.Ya = function (a) {
    ...
    var e = this.a.w;
    return new M(
      this.yb ? nb((a.x + d) / b) : nb((a.x - nb(a.x / e) * e + d) / b),
      nb((a.y + c) / b),
    );
  };
  ...
  function xk(a, b, c, d, e) {
    for (
      var f = b.length, g;
      f-- &&
      !((g = b[f]) && g.Ma && ((a = a.concat(g.Ma(c, d, e))), a.length && e));
    );
    return a;
  }
  O.prototype.kb = x;
  function tk(a) {
    a = a.wa[2];
    return { w: a.right - a.left, h: a.bottom - a.top };
  }
  O.prototype.Dc = function () {
    ...
    f = c.w;
    for (g = c.h; a--; )
      ((c = this.m[a]), (d = c.size), (d.w === f && d.h === g) || cj(c, f, g));
    this.kb = new Th(f, g);
  ...
  O.prototype.Ub = function () {
    ...
    if (q) {
      if (g) for (; g; ) ((h = e - g), q.ca(c, b, m, h, !0, a), --g);
      if (n && this.jc)
        for (
          l = 1;
          l <= n &&
    ...
    this.kb &&
      ((b = this.g),
      b.dispatchEvent(new yi(b.a.Oc, b.m, this.kb, yi.prototype.SIZE)),
      (this.kb = x));
  ...
  O.prototype.jh = function (a, b, c, d, e, f, g) {
    ...
    for (y = 0; y < m; y++)
      (f === n.Yf
        ? ((T = y % k), (J = Math.floor(y / k)))
        : f === n.Qf && ((T = Math.floor(y / l)), (J = y % l)),
        (q = h[T].Fa[J]),
        (t = h[T].Yc),
        q &&
          ((q = q.ca(a, b, this.a, c, d, e)),
          q === ij.ACTIVE && (this.Vb = Infinity),
          q !== ij.DONE || t[J] || (zk(this, this.T[J]), (t[J] = !0)),
          t[J] || (u = !1)));
    return u;
  };
  function zk(a, b) {
    a.dispatchEvent({ type: a.ee.Xf, target: b || a });
  }
  ...
  function Bk(a) {
    return wk({ position: a.a.projection.Fc(a.l) });
  }
  function ek(a, b) {
    var c = Bk(a);
    b && (c.position = b);
  ...
  O.prototype.P = function (a, b) {
    var c = this.Ha().zoom.max,
      ...
      k;
    a.ed() ||
      ((e = new jh(this.a.projection)),
      e.Ja(c),
      (f = e.geoToPixel(a.tb()).round()),
      (g = e.geoToPixel(a.rb()).round()),
      (c = e.w),
      a.g() && (f.x -= c),
      b
        ? ((h = e.geoToPixel(d)),
          (k = 2 * mb(h.x - f.x, g.x - h.x)),
          (h = 2 * mb(h.y - f.y, g.y - h.y)))
        : ((k = g.x - f.x), (h = g.y - f.y), (d = e.a(f.add(g).scale(0.5)))),
      (f = this.wa[4]),
      (e = f.right - f.left),
      (f = f.bottom - f.top),
      (c = -8 + lb(sb((e / k) * c) / Cb, sb((f / h) * c) / Cb) - this.i));
    return { zoom: vk(this, c), position: d };
  };
  ...
  O.prototype.C = function (a, b, c, d, e) {
    ...
    this.f.mb() &&
      ...
      this.f.Fd(Aj.ZOOM) &&
        ...
        ((b = Xi(this.f.a)),
        (a = this.f.hg(this.b)),
        a !== this.b && ((a = bk(this, a)), kk(this, a, b.x, b.y), (f = !0))),
      f && ok(this));
  };
  ...
  O.prototype.s = function (a, b) {
    ...
    this.c.mb() &&
      ...
      (e = tj()),
      (d = e - this.Ld),
      1 <= d && ((f = Fj(this.c)), Ek(this, f, d)),
      !this.o || a || b
        ? "function" === typeof b &&
          ((d = { camera: Bk(this), zoom: this.b - this.i }),
          b(d),
          (d.zoom += this.i),
          Fk(this, d))
        : ((d = Gj(this.c)),
          ...
          !D(k.x) &&
            ...
            ik(
              ...
              function (a, b, d, f) {
                ...
                g = h.c(a * l) * d;
                D(g) ||
                  ((m = k.z * g) && kk(c, bk(c, c.b + m), c.c.atX, c.c.atY),
                  Ck(c, nb(k.x * g), nb(k.y * g)));
              },
              l,
              void 0,
              this.o.Be,
  ...
  O.prototype.Va = function (a) {
    var b = this.I.Ab();
    this.zb({ requested: { camera: b, zoom: b.zoom, animate: !0 } });
    zj(this.Ba, a);
  };
  ...
  O.prototype.ya = function (a, b, c, d) {
    ...
    e.width = (c - a) * g;
    e.height = (d - b) * g;
    for (c = 0; c < this.m.length; c++)
      ((d = this.m[c]), B(d, Cj) && f.drawImage(d.a, -a * g, -b * g));
    return e;
  };
  var Ak = { Qf: 0, Yf: 1 },
    Yj = 1e3;
  ...
  P.prototype.forEach = function (a, b, c) {
    var d, e, f, g;
    if (this.b)
      for (d = this.O, e = d.nextSibling, f = 0; e !== d; )
        ((g = e.nextSibling),
          a.call(c, e, f++, this),
          b && B(e, P) && e.forEach(a, b, c),
          (e = g));
  };
  ...
  function L(a) {
    ...
    this.f = a = new P({ provider: this, min: a.min, max: a.max });
    a.ia(this);
    this.A = new jf();
    this.v = new jf();
    this.j = new jf();
  ...
  L.prototype.V = function (a) {
    ...
    var c = a.S(),
      ...
      e = c.rb();
    b = (c = c.g())
      ? kf(b, d.lat, e.lng, e.lat, d.lng, c)
      : kf(b, d.lat, d.lng, e.lat, e.lng, c);
    b.Lf = a;
    a.Ua = b;
  };
  ...
  function Nk(a, b, c, d, e, f) {
    ...
    this.c = z(this.c, this);
    for (this.L(1); a--; )
      ((f = g[a]), c.push(ch(b, f[0], f[1], f[2], this.f, this.c)));
  }
  v(Nk, Ei);
  ...
  function Qk(a) {
    ...
    for (; (b = e.next(a.b, a.c)); )
      b.cancelled ? b.done(null, "cancelled") : (c.push(b), a.i(b, b.data));
  }
  function Sk() {
    ...
    if (k)
      for (g = []; k--; )
        for (u = a[k], q = u.length, t = 0, l = 1; l < q; l++) {
          if ((y = Vk(u[l - 1], u[l], c, b, d, e)))
            ((m = y[0]),
              (n = y[1]),
              t && t.pa(m) ? h.push(n) : g.push((h = y)),
              (t = n),
              f && ((l = q), (k = 0)));
        }
    else g = a;
  ...
  function dg(a, b, c, d, e, f) {
    ...
    if (k && !f)
      return (
        (k.x += 2.480549651603763e-5),
        (k.y += 7.321997314118067e-5),
        k.zd && ((k.zd.x = k.x), (k.zd.y = k.y)),
        dg(a, b, c, d, e)
      );
    e.Hi = a.x + g * l;
    e.Ii = a.y + g * m;
  ...
  function Xk(a, b, c, d, e) {
    ...
    g >= b || (0 < c && h - d)
      ? (--c,
        1 < h - d
          ? ((d = Xk(a, b, c, d, h)), d.splice(d.length - 1, 1))
          : (d = [a[d]]),
        (d =
          1 < e - h
            ? d.concat(Xk(a, b, c, h, e))
            : d.concat(a.slice(h, e + 1))))
      : (d = [a[d], a[e]]);
    return d;
  }
  ...
  function $k(a) {
    ...
    if (!(e || b.j(d) || b.g(d))) {
      ...
      if (b.f(d))
        for (g = e.length; g--; )
          ((h = e[g]),
            h.j().f(d) && (e.splice(g, 1), (k = k || al(a, h.ta()))));
      if (b.i(d)) {
        for (g = e.length; g--; )
  ...
  Yk.prototype.s = function () {
    ...
    a ||
      ...
      (a = 0),
      (b = this.b),
      this.z && (b -= a += this.j().top),
      (a = this.K = Xe(c.a(new M(a, a)), c.a(new M(b, b)))));
    return a;
  };
  ...
  Yk.prototype.ca = function (a) {
    ...
    if (!$k(this)) {
      for (k = e.length; k--; )
        ((h = e[k]), (f = h.j()), (f.f(d) || f.g(d)) && al(this, h.ta()));
    ...
    if (this.c < this.f) {
      ...
      if ((d = c.length))
        for (
          a.width = a.height = this.b,
            b.clearRect(0, 0, this.b, this.b),
            e = this.g,
            f = 0;
          f < d;
          f++
          ...
          if (
            ((h = c[f]),
            (g = h.ta()),
            (l = (k = e[g]) ? k.b : h.getGeometriesForTile(this)))
          ) {
            if (k) (h.j().b(this.c) && (k.a = Hf(h, l)), (k = k.a));
              ...
              for (
                ...
                if (((u = m[t]), u !== If))
                  for (y = u.Ra, u = y.length; u--; )
                    ((J = y[u]),
                      4 < J.length &&
                        (y[u] = Xk(J, 0.36, q || 0, 0, J.length - 1)));
              this.g[g] = new cl(l, k);
            }
            if (k) {
              b.save();
                ...
                for (h = b, g = l.length, m = m = t = q = q = void 0; g--; )
                  for (
                    q = l[g],
                      ...
                      h.translate(q.x, q.y),
                      h.rotate(q.angle),
                      m = q.lineHeight || 1.375 * m,
                      q = q.lines,
                      t = q.length;
                    t--;
                  )
                    h.fillText(q[t], 0, t * m);
              b.restore();
            }
            n |= k;
          }
  ...
  Yk.prototype.T = function (a, b, c, d) {
    ...
    if (b === If) e && (gl(d, c), d.fillRect(0, 0, k, k));
      ...
      (f && el(d, c, this.Wb),
      c.a && (g = a.s) && ((h = c.lineWidth), g.fd || (g = null)),
      (a = b.b),
      a === Lb)
    ) {
      ...
      (e && (gl(d, c), fl(b, d, !0, !1, e, k, l, 0, a)),
        f && fl(b, d, !1, f, !1, k, l, a),
        g && (gl(d, g), hl(this, d, b, g, h, a)));
  };
  function fl(a, b, c, d, e, f, g, h, k) {
    ...
    if (e && a === If) b.fillRect(0, 0, f, f);
      ...
      for (f = h; f < k; f++) {
        ...
        n = m.length;
        if (m === Tf)
          (b.moveTo(t, t), b.lineTo(t, g), b.lineTo(g, g), b.lineTo(g, t));
        else
          for (l = m[0], b.moveTo(l.x, l.y), h = 1; h < n; h++)
            ((l = m[h]), b.lineTo(l.x, l.y));
        c && b.closePath();
      }
  ...
  function el(a, b, c) {
    ...
    a.setLineDash &&
      (d = b.lineDash) !== De &&
      (a.setLineDash(d), (a.lineDashOffset = b.lineDashOffset));
  }
  function gl(a, b) {
    ...
    for (k = c.length; k-- > f; ) {
      ...
      if (q)
        for (q = lb(pb(n / d), 1e3), q = n / (q + 1), t = q / 2; --m; ) {
          for (y = (J = l[m]).distance((T = l[m - 1])); t <= u + y; )
            ((la = J.x + (T.x - J.x) * (ea = (t - u) / y)),
              (ea = J.y + (T.y - J.y) * ea),
              a.a(la, ea) &&
                (b.save(),
                b.translate(la, ea),
                b.rotate(
                  -Ab((T.y - J.y) / (J.x - T.x)) + (J.x < T.x ? ob : -ob),
                ),
                b.beginPath(),
                b.moveTo(-g, -e),
                b.lineTo(0, e),
  ...
  Yk.prototype.Ma = function (a, b, c) {
    for (
      var d = this.a, e = d.length, f, g, h, k, l, m, n = De, q, t = this.Wb;
      e--;
    )
      if (
        ((g = d[e]), g.getVisibility(!0) && (h = this.g[g.ta()]) && (k = h.b))
      ) {
        f = g.Na();
          ...
          if (!(u = m && l === If) && (u = m || q)) {
            ...
            for (
              ...
              if (
                ...
                il.length = 2 * lk;
                for (sf = 0; sf < lk; sf++)
                  ((Sd = Jb[sf]), (il[2 * sf] = Sd.x), (il[2 * sf + 1] = Sd.y));
                Jb = J && !ia;
                ia = ob && !ia ? 0 : T;
                if (Jb || ia)
  ...
  jl.prototype.o = function (a, b, c, d) {
    ...
    if ((f = this.f.get(e, d)) && (d || $k(f)))
      return (
        (a = this.b.pop() || document.createElement("canvas")),
        f.ca(a) || this.b.push(a),
        this.c.add(e, f, 1),
        f
      );
    d ||
  ...
  p.Re = function (a, b) {
    var c = b[0],
      ...
      c =
        this.c.get(c) ||
        new Yk(c, d, e, f, this.tileSize, this.B, f + this.C, this.m),
  ...
  function Pk(a) {
    ...
    b = "tileSize";
    this[b] = a[b] || 256;
    this.I = { crossOrigin: a.crossOrigin };
    ...
    (this.O = a && !!Gh.prototype.b[Hh] && !!this.b) &&
      this.g.c(z(this.ea, this));
  }
  v(Pk, N);
  ...
  function Jj(a, b) {
    ...
    c.max = 28;
    this.f = new jl(a, c);
    this.i = new oh(this.f, { opacity: 1 });
  ...
  Jj.prototype.b = function (a, b, c) {
    var d = this.j,
      e;
    return d.providesDomMarkers() &&
      (e = d.requestDomMarkers(a, b, !0, c)).length
      ? { markers: e, total: e.length }
      : kl;
  };
  Jj.prototype.requestDomMarkers = Jj.prototype.b;
  var ll = { tiles: De, total: 0 };
  Jj.prototype.g = function (a, b, c, d) {
    var e;
    this.j.providesSpatials()
      ? ((e = this.i.g(a, b, c, d)),
        c ||
          ((c = this.f),
          (e = tj()),
          33 < e - c.j && (Qk(c.v), (c.j = e)),
          (e = this.i.g(a, b, !0, d))))
      : (e = ll);
    return e;
  };
  ...
  var ml = { overlays: De, total: 0 };
  Jj.prototype.C = function (a, b, c) {
    var d = this.j,
      e = ml;
    d.providesOverlays &&
      d.providesOverlays() &&
      ((a = d.requestOverlays(a, b, !0, c)), (b = a.length)) &&
      (e = { overlays: a, total: b });
    return e;
  };
  ...
  function Q(a, b, c) {
    ...
    "transparent" !== d.webkitTapHighlightColor &&
      (d.webkitTapHighlightColor = "rgba(0,0,0,0)");
    a.appendChild(c);
    ...
    b = this.l.imprint;
    if (b !== A && "object" !== typeof b) throw new C(Q, 1, "imprint");
  ...
  function nl(a, b) {
    ...
    a.renderBaseBackground ||
      (a.renderBaseBackground = { lower: 3, higher: 2 });
    return a;
  }
  ...
  Q.prototype.Za = function (a) {
    a.modifiers &&
      (this.F || (ql(this, "start"), (this.F = !0)), ql(this, "", a));
    this.F &&
      (this.Ya && w.clearTimeout(this.Ya),
      (this.Ya = w.setTimeout(this.T, 333)));
  };
  function ql(a, b, c) {
    a.dispatchEvent(
      c ? new yi(a.v.Rf, c.newValue, c.oldValue, c.modifiers) : a.v.Rf + b,
    );
  }
  ...
  Q.prototype.Ga = function (a, b) {
    this.c.Jb({ animate: !!b, position: a });
    return this;
  };
  ...
  Q.prototype.ya = function (a, b, c, d, e, f) {
    ...
    l.capture
      ? ((m = k.ya(T, ea, c, d)),
        (n = m.getContext("2d")),
        (m.style.width = m.width / t + "px"),
        (m.style.height = m.height / t + "px"),
        (u = new Tk(10, g)),
        (b = b.concat(q).filter(function (a) {
  ...
  Q.prototype.C = function (a) {
    a.target === this.m &&
      (this.m.removeEventListener("render", this.C),
      this.m.enter(),
      this.f.Va(this.O));
  };
  ...
  Q.prototype.P = function (a, b) {
    ...
    if (a === ol.PANORAMA)
      return (
        this.j && this.I && this.j.g({ invert: !0 }),
  ...
  Q.prototype.re = function (a, b) {
    -1 === this.fa.indexOf(a) &&
      this.fa.add(a, D(b) ? this.fa.Y.length - 1 : b);
    return this;
  };
  ...
  var tl,
    ul = w.document.currentScript,
    vl;
  ul ||
    ((ul = w.document.querySelector('script[src*="H-"]')),
    ul ||
      ((vl = w.document.getElementsByTagName("script")),
      (ul = vl[vl.length - 1])));
