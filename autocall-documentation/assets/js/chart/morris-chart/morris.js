    ...
    (t.Grid = (function (n) {
      ...
      return (
        ...
        (r.prototype.setData = function (e, n) {
          ...
          (n == null && (n = !0),
            ...
            this.options.goals.length > 0 &&
              ...
              (p = p != null ? Math.min(p, u) : u),
              (h = h != null ? Math.max(h, o) : o)),
            (this.data = function () {
              var n, r, o;
              o = [];
                      ...
                      ((c = n[i]),
                        ...
                        d != null &&
                          (this.cumulative
                            ? (l += d)
                            : h != null
                              ? ((h = Math.max(d, h)), (p = Math.min(d, p)))
                              : (h = p = d)),
                        this.cumulative &&
                          l != null &&
                          ((h = Math.max(l, h)), (p = Math.min(l, p))),
                        r.push(d));
                    return r;
                  }.call(this)),
                  o.push(a));
            ...
            typeof this.options.ymax == "string"
              ? this.options.ymax.slice(0, 4) === "auto"
                ? this.options.ymax.length > 5
                  ? ((this.ymax = parseInt(this.options.ymax.slice(5), 10)),
                    h != null && (this.ymax = Math.max(h, this.ymax)))
                  : (this.ymax = h != null ? h : 0)
                : (this.ymax = parseInt(this.options.ymax, 10))
              : (this.ymax = this.options.ymax),
            typeof this.options.ymin == "string"
              ? this.options.ymin.slice(0, 4) === "auto"
                ? this.options.ymin.length > 5
                  ? ((this.ymin = parseInt(this.options.ymin.slice(5), 10)),
                    p != null && (this.ymin = Math.min(p, this.ymin)))
                  : (this.ymin = p !== null ? p : 0)
            ...
            this.yInterval > 0 && this.yInterval < 1
              ? (this.precision = -Math.floor(
                  Math.log(this.yInterval) / Math.log(10),
                ))
              : (this.precision = 0),
            (this.dirty = !0));
          ...
          if (
            ...
            ((this.elementWidth = n),
              ...
              this.options.axes &&
                ((t = Math.max(
                  this.measureText(
                    this.yAxisFormat(this.ymin),
                    this.options.gridTextSize,
                  ).width,
                  this.measureText(
                    this.yAxisFormat(this.ymax),
                    this.options.gridTextSize,
                  ).width,
                )),
                (this.left += t),
        ...
        (r.prototype.drawGoals = function () {
          var e, t, n, r, i, s;
          ((i = this.options.goals), (s = []));
          for (t = n = 0, r = i.length; n < r; t = ++n)
            ((e = i[t]),
              s.push(
                this.r
                  .path(
                  ...
                  .attr(
                    ...
                    this.options.goalLineColors[
                      t % this.options.goalLineColors.length
                    ],
                  )
          ...
          for (t = n = 0, r = i.length; n < r; t = ++n)
            ((e = i[t]),
              s.push(
                this.r
                  .path(
                    "M" + this.transX(e) + "," + this.bottom + "V" + this.top,
                  )
                  .attr(
                    "stroke",
                    this.options.eventLineColors[
                      t % this.options.eventLineColors.length
                    ],
                  )
        ...
        (r.prototype.drawGrid = function () {
          ...
          for (
            n = s = e, o = this.yInterval;
            e <= t ? s <= t : s >= t;
            n = s += o
          )
            ((r = parseFloat(n.toFixed(this.precision))),
              (i = this.transY(r)),
              this.options.axes &&
                this.r
                  .text(
        ...
        (r.prototype.measureText = function (e, t) {
          ...
          return (
            t == null && (t = 12),
            (r = this.r.text(100, 100, e).attr("font-size", t)),
            (n = r.getBBox()),
            r.remove(),
            n
          );
                      ...
                      ? ((c = parseFloat(f[6])),
                        ...
                        f[8]
                          ? ((o = 0),
                            f[8] !== "Z" &&
                              ((o =
                                parseInt(f[10], 10) * 60 + parseInt(f[11], 10)),
                              f[9] === "+" && (o = 0 - o)),
                            Date.UTC(
                              parseInt(f[1], 10),
                              parseInt(f[2], 10) - 1,
        ...
        (n.prototype.moveTo = function (e, t) {
          ...
          return (
            ...
            t != null
              ...
              : (u = s / 2 - n / 2),
            this.el.css({ left: i + "px", top: u + "px" })
          );
        }),
      ...
      return (
        ...
        (n.prototype.drawXAxis = function () {
          var e,
            ...
            f,
            l = this;
          ((o = this.bottom + this.options.gridTextSize * 1.25),
            (i = null),
            (e = function (e, t) {
              var n, r;
              return (
                (n = l.r
                  .text(l.transX(t), o, e)
                  .attr("font-size", l.options.gridTextSize)
                  .attr("fill", l.options.gridTextColor)),
                (r = n.getBBox()),
                (i == null || i >= r.x + r.width) &&
                r.x >= 0 &&
                r.x + r.width < l.el.width()
                  ? (i = r.x - l.options.xLabelMargin)
                  : n.remove()
              );
            }),
            this.options.parseTime
        ...
        (n.prototype.drawSeries = function () {
          ...
          for (
            t = i = o = this.options.ykeys.length - 1;
            o <= 0 ? i <= 0 : i >= 0;
            t = o <= 0 ? ++i : --i
          )
            ((n = this.paths[t]),
              n !== null &&
                this.r
                  .path(n)
                  .attr("stroke", this.colorFor(r, t, "line"))
                  .attr("stroke-width", this.options.lineWidth));
          ((this.seriesPoints = function () {
            var e, n, r;
            r = [];
            for (
              t = e = 0, n = this.options.ykeys.length;
              0 <= n ? e < n : e > n;
              t = 0 <= n ? ++e : --e
            )
              r.push([]);
            ...
            (a = []));
          for (
            t = s = u = this.options.ykeys.length - 1;
            u <= 0 ? s <= 0 : s >= 0;
            t = u <= 0 ? ++s : --s
          )
            a.push(
              function () {
                ...
                for (n = 0, i = s.length; n < i; n++)
                  ((r = s[n]),
                    r._y[t] != null
                      ? (e = this.r
                          .circle(r._x, r._y[t], this.options.pointSize)
                          .attr("fill", this.colorFor(r, t, "point"))
      ...
      return (
        ...
        (n.prototype.calcPoints = function () {
          ...
          for (r = 0, i = s.length; r < i; r++)
            ((e = s[r]),
              ...
              o.push((e._ymax = e._y[e._y.length - 1])));
          return o;
        }),
        (n.prototype.drawSeries = function () {
          var e, t, r, i;
          for (
            e = r = i = this.options.ykeys.length - 1;
            i <= 0 ? r <= 0 : r >= 0;
            e = i <= 0 ? ++r : --r
          )
            ((t = this.paths[e]),
        ...
        (n.prototype.fillForSeries = function (e) {
          ...
          return (
            ...
            Raphael.hsl(
              t.h,
              Math.min(255, t.s * 0.75),
              Math.min(255, t.l * 1.25),
            )
          );
        }),
        n
      ...
      return (
        ...
        (r.prototype.drawXAxis = function () {
          ...
          ((o = this.bottom + this.options.gridTextSize * 1.25),
            ...
            (f = []));
          for (
            e = u = 0, a = this.data.length;
            0 <= a ? u < a : u > a;
            e = 0 <= a ? ++u : --u
          )
            ((i = this.data[this.data.length - 1 - e]),
              (t = this.r
                .text(i._x, o, i.label)
                .attr("font-size", this.options.gridTextSize)
                .attr("fill", this.options.gridTextColor)),
              this.options.verticalLabels &&
                ((s = Math.round(t.getBBox().width / 3)),
                t.transform("t0," + s + "r90")),
              (n = t.getBBox()),
              (r == null || r >= n.x + n.width) &&
              n.x >= 0 &&
              n.x + n.width < this.el.width()
                ? f.push((r = n.x - this.options.xLabelMargin))
                : f.push(t.remove()));
          return f;
        }),
        (r.prototype.drawSeries = function () {
          ...
          return (
            ...
            (m = this.ymin <= 0 && this.ymax >= 0 ? this.transY(0) : null),
            (this.bars = function () {
              var u, g, y, b;
              ((y = this.data), (b = []));
              for (r = u = 0, g = y.length; u < g; r = ++u)
                ((f = y[r]),
                  (i = 0),
                  b.push(
                    function () {
                      var u, g, y, b;
                      ((y = f._y), (b = []));
                      for (c = u = 0, g = y.length; u < g; c = ++u) {
                        v = y[c];
                        if (v !== null) {
                          (m
                            ? ((d = Math.min(v, m)), (t = Math.max(v, m)))
                            : ((d = v), (t = this.bottom)),
                            (s = this.left + r * n + o),
                            this.options.stacked ||
                              (s += c * (e + this.options.barGap)),
                            (h = t - d),
                            this.options.stacked && (d -= i),
                            (l = this.options.stacked
                              ? "sharp"
                              : this.options.barShape));
                          switch (l) {
                            case "sharp":
                              this.r
                                .rect(s, d, e, h)
                                .attr("fill", this.colorFor(f, c, "bar"))
                                .attr("stroke-width", 0);
                              break;
                            case "soft":
                              ((a = Math.min(Math.round(e / 6), h)),
                                (p = [
                                  "M",
                                  s,
                                  t,
    ...
    (t.Donut = (function () {
      ...
      return (
        ...
        (n.prototype.redraw = function () {
          ...
          ((this.text1 = this.r
            .text(n, r - 10, "")
            .attr({ "font-size": 15, "font-weight": 800 })),
            (this.text2 = this.r.text(n, r + 10, "").attr({ "font-size": 14 })),
            (u = Math.max.apply(
              null,
              function () {
                var e, t, n, r;
        ...
        (n.prototype.select = function (e) {
          ...
          return (
            typeof e == "number" ? (n = this.segments[e]) : (n = e),
            n.select(),
            this.setLabels(
              n.data.label,
              this.options.formatter(n.data.value, n.data),
            )
          );
        }),
      ...
      return (
        ...
        (t.prototype.calcSegment = function (e, t) {
          ...
          return (
            ...
            "M" +
              ...
              "," +
              i +
              ("A" + e + "," + e + ",0," + this.long + ",0," + r + "," + s) +
              ("L" + u + "," + f) +
              ("A" + t + "," + t + ",0," + this.long + ",1," + o + "," + a) +
              "Z"
          );
        }),
        ...
        (t.prototype.render = function (e) {
          ...
          return (
            (this.arc = e
              .path(this.hilight)
              .attr({ stroke: this.color, "stroke-width": 2, opacity: 0 })),
            (this.seg = e
              .path(this.path)
              .attr({ fill: this.color, stroke: "white", "stroke-width": 3 })
              .hover(function () {
