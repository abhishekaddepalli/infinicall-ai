...
!(function (n) {
  function e(n, e) {
    ...
    if (
      ...
      throw new Error(
        `[REQUIRE_FATAL]Relative ID is not allowed in global require: ${i.join(", ")}`,
      );
    var o = C.waitSeconds;
    return (
      o &&
        n instanceof Array &&
        (D && clearTimeout(D), (D = setTimeout(t, 1e3 * o))),
      _(n, e)
    );
  }
  function t() {
  ...
  function i(n, e, t) {
    if (
      (null == t &&
        (null == e
          ? ((t = n), (n = null))
          : ((t = e), (e = null), n instanceof Array && ((e = n), (n = null)))),
      null != t)
    ) {
      var r = window.opera;
      if (
        ...
        (!r || "[object Opera]" !== r.toString())
      ) {
        var i = S();
        n = i && i.getAttribute("data-require-id");
      }
      n ? a(n, e, t) : (H[0] = { deps: e, factory: t });
    }
  }
  function o() {
  ...
  function u(n) {
    ...
    if (e && !l(n, B)) {
      ...
      ($(t, function (t, r) {
        ...
        (c && !P[c]
          ? (f.res &&
              ((u = { id: t, mod: c, res: f.res }),
              (F[c] = 1),
              e.depPMs.push(c),
              e.depRs.push(u)),
            (a = e.depMkv[c]),
            a ||
              ((a = { id: f.mod, absId: c, hard: i > r }),
              e.depMs.push(a),
              (e.depMkv[c] = a),
              o.push(c)))
          : (a = { absId: c }),
    ...
    function t() {
      if (!r && i.state === L) {
        ...
        if (
          ...
          try {
            var a = p(o, { require: i.require, exports: i.exports, module: i }),
              u = i.factory,
    ...
    e instanceof Array &&
      ...
      a ||
        ($(e, function (n) {
          P[n] ||
            l(n, N) ||
            (v(n, o), i[n] || (n.indexOf("!") > 0 ? b : y)(n, r), u(n));
        }),
        f()));
  }
  function y(n) {
  ...
  function k() {
    ((C.baseUrl = C.baseUrl.replace(/\/$/, "") + "/"),
      ...
      (K = []),
      $(C.packages, function (n) {
        var e = n;
        ("string" == typeof n &&
          (e = { name: n.split("/")[0], location: n, main: "main" }),
  ...
  function E(n) {
    var e = /(\.[a-z0-9]+)$/i,
      ...
      i = n,
      o = "";
    (t.test(n) && ((o = RegExp.$1), (n = n.replace(t, ""))),
    ...
    return (
      ...
      a ||
        x(i, K, function (n, e, t) {
          u = u.replace(t.name, t.location);
        }),
      /^([a-z]{2,10}:\/)?\//i.test(u) || (u = C.baseUrl + u),
      (u += r + o),
      x(i, W, function (n) {
        u += (u.indexOf("?") > 0 ? "&" : "?") + n;
      }),
  ...
  var D,
    ...
    L = 3,
    N = 4,
    P = { require: e, exports: 1, module: 1 },
    _ = w(),
    C = {
      baseUrl: "./",
      paths: {},
  ...
  var J,
    ...
    Y,
    Z,
    ne = document.getElementsByTagName("head")[0],
    ee = document.getElementsByTagName("base")[0];
  (ee && (ne = ee.parentNode),
    define || ((define = i), require || (require = e), (esl = e)));
})(this);
