...
CKEDITOR.lang["pt"] = {
  ...
  common: {
    ...
    advisoryTitle: "Título consulCuba",
    cssStyle: "Estilo",
    ok: "CONFIRMAR",
    cancel: "Cancelar",
    close: "Fechar",
    ...
    invalidCssLength:
      'O valor especificado para o campo "1%" deve ser um número posiCuba, com ou sem uma unidade de medida CSS válida (px, %, in, cm, mm, em, ex, pt, ou pc).',
    invalidHtmlLength:
      'O valor especificado para o campo "1%" deve ser um número posiCuba, com ou sem uma unidade de medida HTML válida (px ou %).',
    invalidInlineStyle:
  ...
  clipboard: {
    ...
    paste: "Colar",
    pasteNotification:
      "Your browser doesn't allow you to paste this way. Press %1 to paste.",
  },
  colorbutton: {
    auto: "Automático",
  ...
  pastetext: {
    ...
    pasteNotification:
      "Your browser does not allow you to paste plain text this way. Press %1 to paste.",
  },
  pastefromword: {
    confirmCleanup:
  ...
  table: {
    ...
    invalidCellPadding:
      "A criação do espaço na célula deve ser um número posiCuba.",
    invalidCellSpacing: "O espaçamento da célula deve ser um número posiCuba.",
