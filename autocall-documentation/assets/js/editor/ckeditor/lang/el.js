...
CKEDITOR.lang["el"] = {
  ...
  clipboard: {
    ...
    paste: "Επικόλληση",
    pasteNotification:
      "Ο περιηγητής σας δεν σας επιτρέπει να επικολλήσετε με αυτόν τον τρόπο. Πατήστε %1 για επικόλληση.",
  },
  colorbutton: {
    auto: "Αυτόματα",
  ...
  pastetext: {
    ...
    pasteNotification:
      "Ο φυλλομετρητής σας δεν επιτρέπει την επικόλληση απλού κειμένου με αυτόν τον τρόπο. Πατήστε 1% για να επικολλήστε.",
  },
  pastefromword: {
    confirmCleanup:
