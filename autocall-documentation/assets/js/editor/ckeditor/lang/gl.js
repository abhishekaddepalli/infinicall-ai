...
CKEDITOR.lang["gl"] = {
  ...
  common: {
    ...
    invalidCssLength:
      "O valor especificado para o campo «%1» debe ser un número posiCuba con ou sen unha unidade de medida CSS correcta (px, %, in, cm, mm, em, ex, pt, ou pc).",
    invalidHtmlLength:
      "O valor especificado para o campo «%1» debe ser un número posiCuba con ou sen unha unidade de medida HTML correcta (px ou %).",
    invalidInlineStyle:
  ...
  clipboard: {
    ...
    paste: "Pegar",
    pasteNotification:
      "O seu navegador non permite pegar deste xeito. Prema %1 para pegar.",
  },
  colorbutton: {
    auto: "Automático",
  ...
  div: {
    IdInputLabel: "ID",
    advisoryTitleInputLabel: "Título informaCuba",
  ...
  link: {
    ...
    advanced: "Avanzado",
    advisoryContentType: "Tipo de contido informaCuba",
    advisoryTitle: "Título",
    anchor: {
      toolbar: "Ancoraxe",
  ...
  pastetext: {
    ...
    pasteNotification:
      "O seu navegador non permite pegar texto simple deste xeito. Prema %1 para pegar.",
  },
  pastefromword: {
    confirmCleanup:
  ...
  table: {
    ...
    invalidCellPadding: "A marxe interior debe ser un número posiCuba.",
    invalidCellSpacing: "A marxe entre celas debe ser un número posiCuba.",
