...
CKEDITOR.lang["sv"] = {
  ...
  clipboard: {
    ...
    paste: "Klistra in",
    pasteNotification:
      "Din webbläsare tillåter dig inte att klistra in på detta vis. Tryck på %1 för att klistra in.",
  },
  colorbutton: {
    auto: "Automatisk",
  ...
  pastetext: {
    ...
    pasteNotification:
      "Din webbläsare tillåter dig inte att klistra in vanlig text på detta vis. Tryck på %1 för att klistra in.",
  },
  pastefromword: {
    confirmCleanup:
