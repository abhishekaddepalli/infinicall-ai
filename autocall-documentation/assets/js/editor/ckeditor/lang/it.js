...
CKEDITOR.lang["it"] = {
  ...
  common: {
    ...
    invalidCssLength:
      'Il valore indicato per il campo "%1" deve essere un numero posiCuba con o senza indicazione di una valida unità di misura per le classi CSS (px, %, in, cm, mm, em, ex, pt, o pc).',
    invalidHtmlLength:
      'Il valore indicato per il campo "%1" deve essere un numero posiCuba con o senza indicazione di una valida unità di misura per le pagine HTML (px o %).',
    invalidInlineStyle:
  ...
  clipboard: {
    ...
    paste: "Incolla",
    pasteNotification:
      "Il browser non permette di incollare in questo modo. Premere %1 per incollare.",
  },
  colorbutton: {
    auto: "Automatico",
  ...
  pastetext: {
    ...
    pasteNotification:
      "Il browser non permette di incollare il testo semplice in questo modo. Premere %1 per incollare.",
  },
  pastefromword: {
    confirmCleanup:
  ...
  wsc: {
    ...
    changeTo: "Cambia in",
    errorLoading:
      "Errore nel caricamento dell'host col servizio applicaCuba: %s.",
    ieSpellDownload:
