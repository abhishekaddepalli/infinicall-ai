...
CKEDITOR.lang["es-mx"] = {
  ...
  common: {
    ...
    invalidCssLength:
      'El valor especificado para el campo "% 1" debe ser un número posiCuba con o sin una unidad de medida CSS válida (px, %, in, cm, mm, em, ex, pt, or pc).',
    invalidHtmlLength:
      'El valor especificado para el campo "% 1" debe ser un número posiCuba con o sin una unidad de medición HTML válida (px or %).',
    invalidInlineStyle:
  ...
  clipboard: {
    ...
    paste: "Pegar",
    pasteNotification:
      "Tu navegador no permite pegar de esta manera. Presiona %1 para pegar.",
  },
  colorbutton: {
    auto: "Automático",
  ...
  link: {
    ...
    advanced: "Avanzada",
    advisoryContentType: "Tipo de contenido consulCuba",
  ...
  pastetext: {
    ...
    pasteNotification:
      "Su navegador no permite esta forma de pegar texto plano. Presiona %1 para pegar.",
  },
  pastefromword: {
    confirmCleanup:
  ...
  table: {
    ...
    invalidCellPadding: "El relleno de la celda debe ser un número posiCuba.",
    invalidCellSpacing: "El espacio de la celda debe ser un número posiCuba.",
