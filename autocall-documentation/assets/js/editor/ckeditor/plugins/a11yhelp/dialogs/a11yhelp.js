...
CKEDITOR.dialog.add("a11yHelp", function (e) {
  ...
  var k = [CKEDITOR.ALT, CKEDITOR.SHIFT, CKEDITOR.CTRL],
    r = /\$\{(.*?)\}/g,
    t = function (a, b) {
  ...
  return {
    ...
    contents: [
      {
        id: "info",
        label: e.lang.common.generalTab,
        expand: !0,
        elements: [
          {
            type: "html",
            ...
            html:
              (function () {
                for (
                  ...
                  for (
                    var h = c[f], g = [], e = h.items, k = e.length, p = 0;
                    p < k;
                    p++
                  ) {
                    var m = e[p],
                      n =
                        CKEDITOR.env.edge && m.legendEdge
                          ? m.legendEdge
                          : m.legend,
                      n = n.replace(r, t);
                    n.match(r) ||
