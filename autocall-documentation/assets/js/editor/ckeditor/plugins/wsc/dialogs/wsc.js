  ...
  var B = function (a) {
    ...
    N = function () {
      ...
      setTimeout(function () {
        ...
        d = g.misc.findFocusable(a.dialog.parts.contents);
        if (
          g.misc.hasClass(c, "cke_dialog_tab") ||
          g.misc.hasClass(c, "cke_dialog_contents_body") ||
          !g.misc.isVisible(c)
        )
          for (var e = 0, f; e < d.count(); e++) {
            if (((f = d.getItem(e)), g.misc.isVisible(f.$))) {
              try {
                f.$.focus();
              } catch (h) {}
              break;
  ...
  CKEDITOR.dialog.add("checkspell", function (b) {
    function c(a) {
      ...
      if (!a._.resized) {
        ...
        if (d < f.minWidth || isNaN(d)) d = f.minWidth;
        d > m.width - D && (d = m.width - D);
        ...
        setTimeout(function () {
          a._.fromResizeEvent = !1;
          CKEDITOR.dialog.fire("resize", { dialog: a, width: d, height: g }, b);
        }, 300);
      }
      a._.moved ||
        ...
        isNaN(e) && (e = (m.height - n.height) / 2),
        0 > e && (e = 0),
        e > m.height - n.height && (e = m.height - n.height),
        a.move(c, e, r));
    }
    function d() {
      b.wsc = {};
        ...
        if (CKEDITOR && CKEDITOR.config) {
          ...
          var d =
            ...
            d =
              ...
              d +
                "//www.webspellchecker.net/spellcheck3/script/ssrv.cgi?plugin\x3dfck2\x26customerid\x3d" +
                a.wsc_customerId +
