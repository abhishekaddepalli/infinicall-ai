...
CKEDITOR.dialog.add("colordialog", function (x) {
  ...
  function r(a) {
    a
      ? (e.getById(t).setStyle("background-color", a), e.getById(u).setHtml(a))
      : (e.getById(t).removeStyle("background-color"),
        e.getById(u).setHtml("\x26nbsp;"));
  }
  function E(a) {
    var c = a.data,
      b = c.getTarget(),
            ...
            children: [
              ...
              C,
              {
                ...
                children: [
                  ...
                  C,
                  { type: "button", id: "clear", label: g.clear, onClick: m },
                ],
              },
            ],
          },
