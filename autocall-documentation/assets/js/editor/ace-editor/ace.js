    ...
    function (e, t, n) {
      ...
      function u(e) {
        ...
        function c() {
          (o && (o = clearTimeout(o)),
            f &&
              (i.hide(), (f = null), t.removeEventListener("mousewheel", c)));
        }
        function h(e) {
                  ...
                  ? ((a = []),
                    f.walk(
                      function (e, t, i, s) {
                        var o;
                        if (e != null) {
                          ((o = this.$getDisplayTokens(e, a.length)),
                            (o[0] = n));
      ...
      ((function () {
        ((this.set = function (e) {
          ...
          (this.$assembleMultilineRegExp = function (e, t) {
            ...
            return (
              n[0] == "" ? (r.shift(), (r.offset = 1)) : (r.offset = 0),
              r
            );
          }),
