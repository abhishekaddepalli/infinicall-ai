            ...
            <div className="w-full max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 -mt-16 relative z-20 mb-20">
              <article className="bg-bg-card rounded-lg shadow-2xl shadow-black/5 border border-input-border-color overflow-hidden">
                <div className="p-4 sm:p-12 md:p-16">
                  <div className="public-content text-lg text-subtitle-color leading-relaxed text-left rtl:text-right max-w-4xl mx-auto" >
                    <div 
                      className="
                        break-words
                        [&_h1]:text-4xl [&_h1]:font-extrabold [&_h1]:text-title [&_h1]:mb-6 [&_h1]:mt-10 [&_h1]:tracking-tight
                        [&_h2]:text-3xl [&_h2]:font-bold [&_h2]:text-title [&_h2]:mb-4 [&_h2]:mt-8 [&_h2]:tracking-tight
                        [&_h3]:text-2xl [&_h3]:font-bold [&_h3]:text-title [&_h3]:mb-4 [&_h3]:mt-6
                        [&_h4]:text-xl [&_h4]:font-bold [&_h4]:text-title [&_h4]:mb-3 [&_h4]:mt-5
                        [&_p]:mb-6 [&_p]:text-subtitle-color [&_p]:leading-relaxed
                        [&_a]:text-primary [&_a]:underline-offset-4 hover:[&_a]:underline
                        [&_strong]:text-title [&_strong]:font-bold
                        [&_ul]:list-disc [&_ul]:pl-8 [&_ul]:mb-6 [&_ul_li]:mb-2 [&_ul_li::marker]:text-subtitle-color/50
                        [&_ol]:list-decimal [&_ol]:pl-8 [&_ol]:mb-6 [&_ol_li]:mb-2 [&_ol_li::marker]:text-subtitle-color/50
