          ...
          {canManage ? (
            <>
              <Button
                variant="ghost"
                size="icon"
                className="h-9 w-9 rounded-lg bg-purple-500/10 text-purple-500 hover:bg-purple-500 hover:text-white transition-all "
                onClick={() => handleBonus(row)}
                title={t('add_bonus_credits', 'Add Bonus Credits')}
              >
