...
import { TelephonyProvider } from '@/types/agent'
...
export default function CreateAgentPage() {
  ...
  const [telephonyProvider, setTelephonyProvider] = useState<TelephonyProvider>(TelephonyProvider.ELEVENLABS_TWILIO)
  ...
  useEffect(() => {
    if (agentDetails?.data) {
      ...
      setTelephonyProvider(agent.telephony_provider || TelephonyProvider.ELEVENLABS_TWILIO)
