  ...
  return (
    <>
      <DropdownMenu dir={direction}>
        ...
        <DropdownMenuContent align="end" className="w-64 mt-2 p-1.5 rounded-2xl bg-bg-card  backdrop-blur-xl border border-input-border-color dark:border-white/10 shadow-2xl animate-in fade-in zoom-in-95 duration-200">
