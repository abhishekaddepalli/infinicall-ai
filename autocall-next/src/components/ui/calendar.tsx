  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_start: "bg-primary text-white! rounded-l-lg hover:bg-primary hover:text-primary-foreground",
        range_end: "bg-primary text-white! rounded-r-lg hover:bg-primary hover:text-primary-foreground",
