    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
        <div className="relative flex-1 max-w-[500px]">
          ...
          <Input value={search} onChange={(e) => setSearch(e.target.value)} placeholder={t("search_templates")} className="pl-11 h-11 w-full border-none rounded-xl bg-input-color font-semibold text-xs transition-all focus-visible:ring-1 focus-visible:ring-primary/50" />
        </div>
