...
export function MemberModal({ isOpen, onClose, user }: MemberModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-xl! gap-0 max-w-[calc(100%-2rem)]! max-h-[90vh] sm:p-6 p-4 no-scrollbar overflow-auto border-none rounded-modal-radius shadow-2xl bg-white  dark:border-white/10">
        ...
        <Formik initialValues={initialValues} enableReinitialize validationSchema={userSchemas.create(t)} onSubmit={handleSubmit}>
          {({ setFieldValue, values }) => (
            <Form className="pt-3 space-y-6">
              ...
              <div className="flex items-center justify-between p-4 mb-4 rounded-xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 transition-colors">
