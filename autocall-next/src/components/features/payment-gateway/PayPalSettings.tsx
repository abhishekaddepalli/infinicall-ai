  ...
  return (
    <GatewayCard title={t('paypal')} enabled={config.is_enabled || false} onToggle={handleToggle}>
      <div className="flex flex-col gap-4 animate-in fade-in duration-300">
        ...
        <div className="relative rounded-radius border border-emerald-500/10 bg-emerald-500/2 sm:p-5 p-4 mt-2 overflow-hidden">
          <div className="absolute top-0 right-0 w-24 h-24 bg-emerald-500/5 rounded-full translate-x-8 -translate-y-8 blur-xl pointer-events-none" />

          <div className="flex items-start gap-3">
            <div className="p-1.5 rounded-radius bg-emerald-500/10 text-emerald-500 mt-0.5 animate-pulse-subtle">
