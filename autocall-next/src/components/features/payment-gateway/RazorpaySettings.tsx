      ...
      <div className="flex flex-col gap-4 animate-in fade-in duration-300">
        ...
        <div className="relative rounded-radius border border-indigo-500/10 bg-indigo-500/[0.02] p-5 mt-2 overflow-hidden">
          ...
          <div className="flex items-start gap-3">
            <div className="p-1.5 rounded-radius bg-indigo-500/10 text-indigo-500 mt-0.5 animate-pulse-subtle">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs font-medium text-subtitle-color leading-relaxed">
                ...
                <a
                  ...
                  className="text-indigo-500 dark:text-indigo-400 font-bold hover:underline inline-flex items-center gap-0.5"
                >
