  ...
  return (
    <div className="space-y-6">
      ...
      <TextAreaField
        ...
        className="min-h-[120px] rounded-2xl bg-slate-50 dark:bg-white/5 border-slate-200 dark:border-white/10 font-medium focus:bg-input-color transition-all text-sm resize-none"
      />
    </div>
  )
}
