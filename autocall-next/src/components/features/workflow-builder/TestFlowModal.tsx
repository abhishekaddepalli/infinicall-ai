...
const TestFlowModal = ({ flow, isOpen, onClose }: TestFlowModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[480px]! max-w-[calc(100%-2rem)]! gap-0! max-h-[90vh]  w-[95vw] sm:w-full p-0 bg-bg-card border-input-border-color shadow-lg rounded-modal-radius overflow-auto no-scrollbar">
