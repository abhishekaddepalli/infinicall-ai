...
import { Language, LanguageTableProps } from '@/types/language'
      ...
      cell: (row: Language) => (
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-md text-subtitle-color font-medium">{row.locale}</span>
          </div>
        </div>
      ),
    },
