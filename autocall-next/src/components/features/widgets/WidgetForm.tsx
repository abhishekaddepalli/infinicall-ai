                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex gap-3 items-center">
                              <div className="relative w-11 h-11 rounded-xl overflow-hidden border border-input-border-color shrink-0 shadow-sm transition-all  hover:ring-primary/20">
                                <Input
                                  type="color"
