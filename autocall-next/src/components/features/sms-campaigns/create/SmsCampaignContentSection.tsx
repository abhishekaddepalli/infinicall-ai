    ...
    <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {smsTemplatesOptions.map((template) => (
                    <div
                      ...
                      className={`cursor-pointer rounded-lg sm:p-5 p-4 border transition-all duration-300 ${
                        values.smsTemplateId === template.value
      ...
      <div className="space-y-2">
        <TextAreaField
          ...
          className="min-h-[160px] rounded-2xl bg-slate-50 dark:bg-white/5 border-slate-200 dark:border-white/10 font-bold focus:bg-white dark:focus:bg-zinc-900 transition-all text-sm shadow-inner resize-none"
        />
