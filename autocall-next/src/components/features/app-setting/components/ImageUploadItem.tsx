...
import { ImageUploadItemProps } from '@/types/settings'
...
const ImageUploadItem = ({
  ...
  return (
    <div className="flex flex-col gap-4 sm:p-6 p-4 rounded-radius border border-input-border-color bg-subcard transition-all duration-300 group">
      ...
      <div
        className={`relative h-28 w-full rounded-radius overflow-hidden border-2 border-dashed transition-all duration-300 flex items-center justify-center cursor-pointer
          ${displayUrl ? 'border-primary/10 bg-primary/5' : 'border-primary/10 bg-primary/5'}
        `}
        ...
        {displayUrl ? (
          <div className="relative w-full h-full group/image">
            ...
            <div className="absolute inset-0 bg-white/40 opacity-0 group-hover/image:opacity-100 flex items-center justify-center transition-opacity duration-300">
              <div className="bg-primary rounded-radius text-white p-3 ">
          ...
          <div className="flex flex-col items-center gap-2 text-muted-foreground/50 group-hover:text-primary transition-colors">
            <div className="p-3 rounded-full bg-primary/10 border border-primary/20 group-hover:bg-primary/10 group-hover:border-primary/30 transition-all duration-500">
