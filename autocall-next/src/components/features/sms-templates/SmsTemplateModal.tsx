...
export const SmsTemplateModal = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-125! max-w-[calc(100%-2rem)] max-h-[90vh] no-scrollbar gap-0 bg-bg-card border-none shadow-2xl rounded-modal-radius p-0 overflow-auto">
