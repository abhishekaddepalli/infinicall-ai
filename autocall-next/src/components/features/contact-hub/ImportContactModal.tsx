...
export function ImportContactModal({ isOpen, onClose, onConfirm, isLoading }: ImportContactModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={resetAndClose}>
      <DialogContent className="max-w-xl p-0 rounded-[2.5rem] border-none shadow-2xl bg-white  overflow-hidden flex flex-col">
        <DialogHeader className="p-10 pb-6 shrink-0 bg-gradient-to-b from-primary/5 to-transparent">
          <div className="space-y-1">
            ...
            <DialogDescription className="text-muted-foreground/60 font-bold text-sm ml-1">
              {t('import_contacts_desc')}
            </DialogDescription>
          </div>
        </DialogHeader>
