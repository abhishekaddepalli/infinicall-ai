...
export function ContactModal({ isOpen, onClose, onConfirm, initialData, isLoading }: ContactModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-xl! max-w-[calc(100%-2rem)]! p-0 rounded-modal-radius gap-0 border-input-border-color shadow-2xl bg-white overflow-auto no-scrollbar max-h-[90vh] flex flex-col">
