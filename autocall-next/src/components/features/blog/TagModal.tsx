...
const TagModal = ({ isOpen, onClose, tag }: TagModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md! max-w-[calc(100%-2rem)] border-input-border-color bg-bg-card rounded-modal-radius gap-0 shadow-2xl p-0 overflow-hidden">
