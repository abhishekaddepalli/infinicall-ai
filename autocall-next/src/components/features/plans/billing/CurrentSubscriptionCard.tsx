...
import { CurrentSubscriptionCardProps } from '@/types/plans'
import { formatDate } from '@/utils/auth'
import { motion } from 'framer-motion'
import { AlertTriangle, Calendar, History, Rocket, X } from 'lucide-react';
...
const CurrentSubscriptionCard = ({ subscription, isCanceling, onCancel }: CurrentSubscriptionCardProps) => {
  ...
  return (
    <motion.div
      ...
      className="max-w-4xl mx-autobg-bg-cardrounded-[2.5rem] border border-glass-border overflow-hidden shadow-sm"
    >
