      ...
      <div className="lg:col-span-1">
        ...
        >
          <div className="flex items-center justify-between pb-4 shrink-0">
            ...
            <Link href={ROUTES.CONTACT_HUB} className="text-md font-bold text-subtitle-color cursor-pointer whitespace-nowrap shrink-0 ml-4">
              {t('see_all', 'See All')}
            </Link>
          </div>
      ...
      <div className="lg:col-span-1">
        ...
        >
          <div className="flex items-center justify-between pb-4 shrink-0">
            ...
            <Link href={ROUTES.SMS_CAMPAIGNS} className="text-md font-bold text-subtitle-color cursor-pointer whitespace-nowrap shrink-0 ml-4">
              {t('see_all', 'See All')}
            </Link>
          </div>
