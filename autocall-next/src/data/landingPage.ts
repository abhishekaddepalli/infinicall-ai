...
export const defaultPlansData: any[] = [
  {
    ...
    slug: "starter-plan",
    description:
      "Ideal for Indian startups and developers building with Sarvam AI Telugu & Plivo.",
    amount: 999,
    is_popular: false,
  },
  {
    ...
    slug: "pro-scale-plan",
    description:
      "Perfect for expanding Indian businesses needing concurrent Telugu AI calling limits.",
    amount: 2999,
    is_popular: true,
  },
  {
    ...
    description:
      "Tailored options for enterprise teams needing custom Sarvam AI models & dedicated Plivo SIP trunks.",
    amount: 9999,
    is_popular: false,
  },
];
