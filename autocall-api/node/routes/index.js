...
const {
  ...
  getBlockSetup,
  postUnblockVerify,
} = require("../src/controllers/InstallController");
...
router.get(
  "/unblock/:project_id",
  setRouteName("install.unblock.show"),
  getUnblock
);
router.get(
  "/block/:project_id",
  setRouteName("install.block.api"),
  getBlockProject
);
...
router.post(
  "/block/license/verify",
  setRouteName("install.unblock"),
  ...[].concat(postUnblockVerify)
);
...
router.get(
  "/requirements",
  setRouteName("install.requirements"),
  getRequirements
);
...
router.post(
  "/license",
  setRouteName("install.license.setup"),
  ...[].concat(postLicense)
);
router.post(
  "/database",
  setRouteName("install.database.config"),
  ...[].concat(postDatabaseConfig)
);
