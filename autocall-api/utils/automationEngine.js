...
class AutomationEngine {
  ...
  async executeBookSlot(node, data) {
    ...
    if (details.name && details.date && !details.time) {
      prompt = "Got it. And what time would you prefer?";
    }
      ...
      try {
        ...
        if (!details.name || !details.date) {
          return {
            success: true,
            output: {
              last_message: "Could you please provide your name and preferred date for the appointment?",
              description: "Could you please provide your name and preferred date for the appointment?",
        ...
        if (!details.time) {
          return {
            success: true,
            output: {
              last_message: "Got it. And what time would you prefer?",
              description: "Got it. And what time would you prefer?",
              appointment_details: details
            },
            shouldPause: true
          };
