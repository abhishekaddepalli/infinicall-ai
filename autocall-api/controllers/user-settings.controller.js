...
exports.updateUserSetting = async (req, res) => {
  try {
    ...
    if (sarvam_api_key !== undefined && !isMasked(sarvam_api_key)) userSettings.sarvam_api_key = sarvam_api_key;
    ...
    if (plivo_phone_number !== undefined) userSettings.plivo_phone_number = plivo_phone_number;
